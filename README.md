...
| direct `AnyOf2..12` / nested `WithAnyOf2..12` / `PairWithAnyOf2..12` world query data; system-param wrappers through 10 | done for world query data 12; system-param wrappers still 10 | `lib/world_table_erased.sla`, `lib/system_param_table_erased.sla` |
