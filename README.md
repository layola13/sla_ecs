...
├── system_param_table_erased_relationship.sla — TableErasedRelationshipWorld query/relationship/RemovedComponents/Commands/ResMut/message system-param adapters, including MessageReader/MessageWriter and conflicting pair-query ParamSet batching
