...
| direct `AnyOf2..12` / nested `WithAnyOf2..12` / `PairWithAnyOf2..12` world query data and ordinary system-param wrappers; relationship/observer wrappers through 10 | done for world and ordinary system-param 12; relationship/observer wrappers still 10 | `lib/world_table_erased.sla`, `lib/system_param_table_erased.sla` |
