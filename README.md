...
| direct `AnyOf2..12` / nested `WithAnyOf2..12` / `PairWithAnyOf2..12` world query data and ordinary/relationship system-param wrappers; observer wrappers through 10 | done for world, ordinary system-param, and relationship 12; observer wrappers still 10 | `lib/world_table_erased.sla`, `lib/system_param_table_erased.sla`, `lib/system_param_table_erased_relationship.sla` |
