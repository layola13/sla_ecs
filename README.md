...
├── parallel_iterator.sla — Bevy `ParallelIterator`-style `Vec<i32>` batch consumers: count/sum/product/min/max/collect/map/partition/fold/all/any/position
...
| Bevy `ParallelIterator`-style batch consumers | done on generated-SA; SAB issue documented | `lib/parallel_iterator.sla`, `sa_plugin_sla/docs/sab_thread_closure_fnptr_parallel_iterator_issue_cn.md` |
