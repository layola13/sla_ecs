...
├── world_table_erased.sla — Archetype table-row type-erased heterogeneous component storage
...
├── schedule_table_erased.sla — TableErasedWorld Schedule with access tracking and parallel batch planning
