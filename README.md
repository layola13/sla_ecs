...
- Component registration has runtime Sla metadata IDs plus verified type-id lookup helpers today; automatic Rust-style `#[derive(Component)]` metadata generation is not implemented.
