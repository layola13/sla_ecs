...
├── messages.sla      — Generic fixed-capacity Messages<T>, MessageWriter<T>, monotonic numeric message ids, read-with-id/get-by-id, MessageMutator-style mutable reads, reader cursor, unread length, empty, and clear helpers
