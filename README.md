...
├── system_param_table_erased_relationship.sla — TableErasedRelationshipWorld query/relationship/RemovedComponents/Commands/ResMut/message system-param adapters, including MessageReader/MessageWriter, conflicting pair-query ParamSet batching, Commands + pair-mut query runners, Commands + ResMut runners, and MessageReader + Commands runners
