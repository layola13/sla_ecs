...
├── system_param_table_erased_relationship.sla — TableErasedRelationshipWorld query/relationship/RemovedComponents/Commands/ResMut/message system-param adapters, including MessageReader/MessageWriter, conflicting pair-query ParamSet batching, Commands + pair-mut query runners, Commands + ResMut runners, pair-mut + ResMut + Commands runners, MessageReader + Commands runners, and MessageWriter + Commands runners
