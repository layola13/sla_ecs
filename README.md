...
├── commands_table_erased_relationship.sla — Ordered table-erased component + indexed relationship/resource/message commands
...
├── table_erased_relationship_commands_demo.sla — Ordered table-erased component + indexed relationship commands demo
