...
- Component registration metadata is explicit Sla runtime metadata with type-id lookup helpers; automatic derive/type metadata generation is still pending.
