...
- [done] Extended multi-threaded executor deep coverage for state metadata accessors in `lib/executor_multi_threaded_deep.sla`. The deep module now exposes read-only helpers for the fixed cap and `EcsExecutorStateDeep` system/set counts, preserving initialization and slot mutation behavior. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 118 tests, adding 2 state metadata accessor tests. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `state_metadata_accessor` passes 2/2 with a 90s timeout; focused SA backend filter `state_metadata_accessor` passes 2/2 with a 150s timeout; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor state metadata accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep isolated tests to use existing accessors instead of direct fields for state metadata, ready-batch count/flags, and system-spec drive flags. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filters `state_init`, `ready_batch`, `tick_after_completion`, and `system_spec_drive_flags` passed with `--jobs 1`; focused SA backend exact test-name filters passed serially for all six edited tests with `--jobs 1` and 180s timeouts; `git diff --check` passed. A concurrent SA backend verification attempt timed out without panic output, so subsequent SA verification was kept serial and exact-filtered to avoid memory/resource contention. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor isolated accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep condition-fold tests to use existing `ecs_executor_condition_fold_deep_*` accessors instead of direct result fields. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `condition_fold_` passed 6/6 with `--jobs 1` and a 90s timeout; focused SA backend filter `condition_fold_` passed 6/6 with `--jobs 1` and a 150s timeout; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor condition-fold accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep error-state tests to use existing `ecs_executor_error_state_deep_*` accessors instead of direct result fields. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `error_state_records` passed 2/2 with `--jobs 1` and a 90s timeout; focused SA backend filter `error_state_records` passed 2/2 with `--jobs 1` and a 150s timeout; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor error-state accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep finish-run summary tests to use existing `ecs_executor_finish_run_summary_deep_*` accessors instead of direct result fields. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `finish_run_summary` passed 4/4 with `--jobs 1` and a 90s timeout; focused SA backend filter `finish_run_summary` passed 4/4 with `--jobs 1` and a 150s timeout; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor finish-run summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep begin-run summary tests to use existing `ecs_executor_begin_run_summary_deep_*` accessors instead of direct result fields. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `begin_run_summary` passed 4/4 with `--jobs 1` and a 90s timeout; focused SA backend filter `begin_run_summary` passed 4/4 with `--jobs 1` and a 150s timeout; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor begin-run summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep completed-tick error summary tests to use existing `ecs_executor_completed_tick_error_summary_deep_*` accessors instead of direct result fields. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `completed_tick_error_` passed 6/6 with `--jobs 1` and a 90s timeout; focused SA backend filter `completed_tick_error_` passed 6/6 with `--jobs 1` and a 150s timeout; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor completed-tick error summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep drive-one summary tests to use existing `ecs_executor_drive_summary_deep_*` accessors instead of direct result fields. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `drive_one_` passed 3/3 with `--jobs 1` and a 90s timeout; focused SA backend filter `drive_one_` passed 3/3 with `--jobs 1` and a 150s timeout; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-one summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up the multi-threaded executor deep drive-ready-batch summary test to use existing `ecs_executor_drive_summary_deep_*` accessors instead of direct result fields. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `drive_ready_batch_summary` passed 1/1 with `--jobs 1` and a 90s timeout; focused SA backend filter `drive_ready_batch_summary` passed 1/1 with `--jobs 1` and a 150s timeout; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up the multi-threaded executor deep lock-failed drive summary test to use existing `ecs_executor_drive_summary_deep_*` accessors instead of direct result fields. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `lock_failed_summaries` passed 1/1 with `--jobs 1` and a 90s timeout; focused SA backend filter `lock_failed_summaries` passed 1/1 with `--jobs 1` and a 150s timeout; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor lock-failed drive summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed a multi-threaded executor deep no-completion tick-loop summary gap found during accessor cleanup: width-2 ready batches were reported as one selected system, failing `mt_deep_tick_loop_no_completion_waves_ticks_once` at `148082` and the existing tick-loop summary accessor batch test at `148639`. `ecs_executor_tick_loop_deep_no_completion_waves3` now builds from the drive-ready-batch integration summary and maps run/skipped slots into `EcsExecutorTickLoopSummaryDeep`; the early no-completion test now uses tick-loop summary accessors instead of direct fields. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend filters `tick_loop_no_completion_waves`, `tick_loop_summary_accessor`, `tick_loop_skipped_accessor`, and `ready_batch_rescan` passed with `--jobs 1`; SA backend filters `tick_loop_no_completion_waves`, `tick_loop_summary_accessor`, and `tick_loop_skipped_accessor` passed after serial reruns with 180s timeouts and `--jobs 1`; `git diff --check` passed. An accidental parallel SA backend attempt timed out without panic output, so reported SA results are from serial reruns. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor tick-loop no-completion summary behavior 0% -> 100% for this focused fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep tick-loop summary tests to use existing `ecs_executor_tick_loop_summary_deep_*` accessors instead of direct result fields for two-completion-wave batches and retry-pending counts. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filters `tick_loop_two_completion_waves` and `tick_loop_retry_pending` each passed 1/1 with `--jobs 1` and a 90s timeout; focused SA backend filters were run serially with 180s timeouts and each passed 1/1; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor tick-loop summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep run-history tests to use existing `ecs_executor_run_history_deep_*` accessors instead of direct result fields for run/apply/skipped counts and stalled state. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `run_history_` passed 5/5 with `--jobs 1` and a 90s timeout; focused SA backend filter was run serially with a 180s timeout and passed 5/5; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor run-history accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed a multi-threaded executor deep drive-all history behavior gap found during accessor cleanup: the dependency-chain path could record only a partial run order instead of `0, 1, 2`. `ecs_executor_run_history_deep_drive_all3` now reuses `ecs_executor_drive_all_batched_integration_summary_deep3` with `max_width=1` and maps the batched integration run/skipped/stalled/apply metadata into `EcsExecutorRunHistoryDeep`, preserving ApplyDeferred pending-unapplied ordering and merging apply slots without duplicates. The edited drive-all history tests now use `ecs_executor_run_history_deep_*` accessors for counts and stalled state; `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filters `drive_all_history` passed 4/4, `drive_all_batched_accessor` passed 2/2, and `drive_all_batched_integration` passed 4/4 with `--jobs 1` and 90s timeouts; focused SA backend filters were run serially with 180s timeouts and passed 4/4, 2/2, and 4/4 respectively; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-all history integration behavior 0% -> 100% for this focused fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep ready-batch rescan tests to use existing `ecs_executor_ready_batch_rescan_summary_deep_*` accessors instead of direct result fields for selected/skipped counts and slots, rescan count, and post-rescan ready/running/completed counts. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `ready_batch_rescan` passed 6/6 with `--jobs 1` and a 90s timeout; focused SA backend filter was run serially with a 180s timeout and passed 6/6; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor ready-batch rescan accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep complete-ready-batch tests to use existing `ecs_executor_complete_ready_batch_summary_deep_*` accessors instead of direct result fields for started/completed/apply counts and slots, post-batch ready/running/completed/unapplied counts, and local/exclusive gate state. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `complete_ready_batch` passed 6/6 with `--jobs 1` and a 90s timeout; focused SA backend filter was run serially with a 180s timeout and passed 6/6; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor complete-ready-batch accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep initial-skip tests to use existing `ecs_executor_initial_skips_summary_deep_*` accessors instead of direct result fields for skipped/ignored counts and slots, post-skip ready/completed/skipped counts, dependency counters, and ready flags. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `initial_skip` passed 6/6 with `--jobs 1` and a 90s timeout; focused SA backend filter was run serially with a 180s timeout and passed 6/6; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor initial-skip accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep completion-queue drain tests to use existing `ecs_executor_completion_queue_drain_summary_deep_*` accessors instead of direct result fields for completed/ignored/apply counts and slots, post-drain ready/running/completed/unapplied counts, dependency counters, ready flags, and local/exclusive gate state. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `completion_queue` passed 6/6 with `--jobs 1` and a 90s timeout; focused SA backend filter was run serially with a 180s timeout and passed 6/6; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor completion-queue accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep tick-with-completions tests to use existing `ecs_executor_tick_with_completions_summary_deep_*` accessors instead of direct result fields for completed/ignored/selected/skipped/apply counts and slots, post-tick ready/running/completed/unapplied counts, dependency counters, and local/exclusive gate state. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `tick_with_completion` passed 6/6 with `--jobs 1` and a 90s timeout; focused SA backend filter was run serially with a 180s timeout and passed 6/6; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor tick-with-completions accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep drive-ready-batch integration tests to use existing `ecs_executor_drive_ready_batch_integration_summary_deep_*` accessors instead of direct result fields for run/completed/skipped/apply counts and slots, post-drive ready/running/completed/unapplied counts, stalled state, and dependency counters. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filters `drive_ready_batch_integration` passed 4/4 and `drive_ready_batch_accessor` passed 2/2 with `--jobs 1` and 90s timeouts; focused SA backend filters were run serially with 180s timeouts and passed 4/4 and 2/2 respectively; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch integration accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Cleaned up multi-threaded executor deep drive-all-batched integration tests to use existing `ecs_executor_drive_all_batched_integration_summary_deep_*` accessors instead of direct result fields for wave/run/completed/skipped counts and slots, post-drive running/completed counts, stalled state, and dependency counters. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` remains at 118 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filters `drive_all_batched_integration` passed 4/4 and `drive_all_batched_accessor` passed 2/2 with `--jobs 1` and 90s timeouts; focused SA backend filters were run serially with 180s timeouts and passed 4/4 and 2/2 respectively; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are unchanged: 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6799 tests-dir `@test` annotations, and 7435 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-all-batched integration accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-all-batched integration coverage with `mt_deep_drive_all_batched_integration_apply_deferred_releases_next_wave`, a three-wave scenario where system 0 completes with a deferred buffer, system 1 is an `ApplyDeferred` barrier that records/apply-flushes system 0, and system 2 is released into the final wave. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 119 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `apply_deferred_releases_next_wave` passed 1/1; focused default backend filters `drive_all_batched_integration` and `drive_all_batched_accessor` passed 5/5 and 2/2 with `--jobs 1` and 90s timeouts; focused SA backend filters were run serially with 180s timeouts and passed 5/5 and 2/2 respectively. An exact SA single-test filter printed PASS but returned 143 once, so same-surface SA completion evidence uses the broader integration filter. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6800 tests-dir `@test` annotations, and 7436 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-all-batched ApplyDeferred multi-wave integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-ready-batch integration coverage with `mt_deep_drive_ready_batch_integration_apply_deferred_releases_dependent`, a single-batch scenario where a prior completed deferred system is pending unapplied, an `ApplyDeferred` barrier flushes it, and the barrier completion releases a dependent ordinary system to the ready queue for a later batch. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 120 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `apply_deferred_releases_dependent` passed 1/1; focused default backend filters `drive_ready_batch_integration` and `drive_ready_batch_accessor` passed 5/5 and 2/2 with `--jobs 1` and 90s timeouts; focused SA backend filters were run serially with 180s timeouts and passed 5/5 and 2/2 respectively; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6801 tests-dir `@test` annotations, and 7437 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch ApplyDeferred dependent-release integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-all-batched integration coverage with `mt_deep_drive_all_batched_integration_max_waves_stalls_after_progress`, a capped dependency-chain scenario where drive-all-batched completes one wave, releases the next system to ready, then reports stalled because `max_waves=1` stops remaining ready work. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 121 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `max_waves_stalls_after_progress` passed 1/1; focused default backend filters `drive_all_batched_integration` and `drive_all_batched_accessor` passed 6/6 and 2/2 with `--jobs 1` and 90s timeouts; focused SA backend filters were run serially with 180s timeouts and passed 6/6 and 2/2 respectively; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6802 tests-dir `@test` annotations, and 7438 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-all-batched max-waves partial-progress stall coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-all-batched integration coverage with `mt_deep_drive_all_batched_integration_local_gate_splits_waves`, an all-ready scenario with two local systems and one ordinary system where the first wave runs local system 0 and ordinary system 2, then the second wave runs local system 1 after the local gate clears. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 122 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `local_gate_splits_waves` passed 1/1; focused default backend filters `drive_all_batched_integration` and `drive_all_batched_accessor` passed 7/7 and 2/2 with `--jobs 1` and 90s timeouts; focused SA backend filters were run serially with 180s timeouts and passed 7/7 and 2/2 respectively; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6803 tests-dir `@test` annotations, and 7439 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-all-batched local-gate wave splitting coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-all-batched integration coverage with `mt_deep_drive_all_batched_integration_exclusive_gate_splits_waves`, an all-ready scenario with one exclusive system and two ordinary systems where the exclusive system occupies the first wave alone, then ordinary systems 1 and 2 run together in the second wave. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 123 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `exclusive_gate_splits_waves` passed 1/1; focused default backend filter `drive_all_batched_integration` passed 8/8 with a clean 120s rerun after an earlier 90s run printed 8/8 PASS but returned 143; focused default backend filter `drive_all_batched_accessor` passed 2/2 with `--jobs 1` and a 90s timeout; focused SA backend filters were run serially with 180s timeouts and passed 8/8 and 2/2 respectively; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6804 tests-dir `@test` annotations, and 7440 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-all-batched exclusive-gate wave splitting coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-ready-batch integration coverage with `mt_deep_drive_ready_batch_integration_exclusive_gate_stands_alone`, an all-ready scenario with one exclusive system and two ordinary systems where a single ready-batch drive runs and completes only the exclusive system, leaving ordinary systems 1 and 2 ready for a later batch. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 124 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `exclusive_gate_stands_alone` passed 1/1; focused default backend filters `drive_ready_batch_integration` and `drive_ready_batch_accessor` passed 6/6 and 2/2 with `--jobs 1` and 90s timeouts; focused SA backend filters were run serially with 180s timeouts and passed 6/6 and 2/2 respectively; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6805 tests-dir `@test` annotations, and 7441 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch exclusive-gate stand-alone coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-ready-batch integration coverage with `mt_deep_drive_ready_batch_integration_local_gate_keeps_second_local_ready`, an all-ready scenario with two local systems and one ordinary system where a single ready-batch drive runs local system 0 and ordinary system 2, leaving local system 1 ready for a later batch. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 125 tests; no executor implementation or API behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `local_gate_keeps_second_local_ready` passed 1/1; focused default backend filters `drive_ready_batch_integration` and `drive_ready_batch_accessor` passed 7/7 and 2/2 with `--jobs 1` and 90s timeouts; focused SA backend filters were run serially with 180s timeouts and passed 7/7 and 2/2 respectively; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 425 test files, 249 deep isolated test files, 90 examples, 6806 tests-dir `@test` annotations, and 7442 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch local-gate ready-preservation coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep tick-loop no-completion coverage with `mt_deep_tick_loop_no_completion_exclusive_gate_stands_alone` and `mt_deep_tick_loop_no_completion_local_gate_keeps_second_local_ready`, two tick-loop-facing scenarios that route through the existing drive-ready-batch integration summary path. The exclusive scenario proves an exclusive system stands alone even when ordinary systems are ready; the local scenario proves the first local system can batch with an ordinary system while the second local system stays out of that batch. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 127 tests; no executor implementation, API behavior, or SLA compiler behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filters `tick_loop_no_completion_exclusive_gate_stands_alone` and `tick_loop_no_completion_local_gate_keeps_second_local_ready` each passed 1/1 with `--jobs 1` and 90s timeouts; focused default backend filter `tick_loop_no_completion` passed 3/3 with a 120s timeout; focused SA backend filter `tick_loop_no_completion` passed 3/3 serially with a 180s timeout; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6808 tests-dir `@test` annotations, and 7444 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor no-completion tick-loop gate summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep tick-loop two-completion-wave coverage with `mt_deep_tick_loop_two_completion_waves_exclusive_gate_splits_batches` and `mt_deep_tick_loop_two_completion_waves_local_gate_splits_batches`, two completion-wave scenarios that route through the existing ready-batch rescan summary path. The exclusive scenario proves a released exclusive system occupies wave 0 alone and the ordinary released system appears in wave 1; the local scenario proves two released local systems split across wave 0 and wave 1. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 129 tests; no executor implementation, API behavior, or SLA compiler behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filters `tick_loop_two_completion_waves_exclusive_gate_splits_batches` and `tick_loop_two_completion_waves_local_gate_splits_batches` each passed 1/1 with `--jobs 1` and 90s timeouts; focused default backend filter `tick_loop_two_completion_waves` passed 3/3 with a 120s timeout; focused SA backend filter `tick_loop_two_completion_waves` passed 3/3 serially with a 180s timeout; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6810 tests-dir `@test` annotations, and 7446 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor completion-wave tick-loop gate summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep tick-with-completions coverage with `mt_deep_tick_with_completions_summary_exclusive_gate_stands_alone` and `mt_deep_tick_with_completions_summary_local_gate_keeps_second_local_ready`, two completion-drain scenarios that release gated ready work before same-tick selection. The exclusive scenario proves a released exclusive system is selected alone, leaves ordinary work ready, and records both exclusive and local gate occupancy because this flat model treats exclusive execution as local-thread occupancy; the local scenario proves the first released local system is selected while the second local system stays ready. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 131 tests; no executor implementation, API behavior, or SLA compiler behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `tick_with_completions_summary_exclusive_gate_stands_alone` passed 1/1 with `--jobs 1` and a 150s timeout after an earlier 90s run exited 124 without output; default backend exact filter `tick_with_completions_summary_local_gate_keeps_second_local_ready` passed 1/1 with `--jobs 1` and a 90s timeout; focused default backend filter `tick_with_completion` passed 8/8 with a 150s timeout; focused SA backend filter `tick_with_completion` passed 8/8 serially with a 240s timeout; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6812 tests-dir `@test` annotations, and 7448 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor tick-with-completions gate summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep completion-queue drain coverage with `mt_deep_completion_queue_drain_summary_local_completion_clears_gate` and `mt_deep_completion_queue_drain_summary_exclusive_completion_clears_gates`, two focused ordinary-completion scenarios for running gated systems. The local scenario proves completion-queue drain clears local gate state after completing a local system; the exclusive scenario proves completing an exclusive system clears both exclusive and local gate state. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 133 tests; no executor implementation, API behavior, or SLA compiler behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filters `completion_queue_drain_summary_local_completion_clears_gate` and `completion_queue_drain_summary_exclusive_completion_clears_gates` each passed 1/1 with `--jobs 1` and 90s timeouts; focused default backend filter `completion_queue` passed 8/8 with a 120s timeout; focused SA backend filter `completion_queue` passed 8/8 serially with a 240s timeout; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6814 tests-dir `@test` annotations, and 7450 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor completion-queue gate cleanup summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep complete-ready-batch coverage with `mt_deep_complete_ready_batch_summary_local_start_completion_clears_gate` and `mt_deep_complete_ready_batch_summary_exclusive_start_completion_clears_gates`, two focused fresh-start scenarios for gated systems selected into a ready batch. The local scenario proves a selected local system starts, completes, and clears local gate state; the exclusive scenario proves a selected exclusive system starts, completes, and clears both exclusive and local gate state. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 135 tests; no executor implementation, API behavior, or SLA compiler behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filters `complete_ready_batch_summary_local_start_completion_clears_gate` and `complete_ready_batch_summary_exclusive_start_completion_clears_gates` each passed 1/1 with `--jobs 1` and 90s timeouts; focused default backend filter `complete_ready_batch` passed 8/8 with a 150s timeout; focused SA backend filter `complete_ready_batch` passed 8/8 serially with a 240s timeout; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6816 tests-dir `@test` annotations, and 7452 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor complete-ready-batch gate cleanup summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep ready-batch rescan coverage with `mt_deep_ready_batch_rescan_local_gate_keeps_second_local_ready_after_skip`, a skip/rescan scenario where a skipped system releases a dependent local system while another local system is already ready. The test proves the released local system is selected, the second local system remains ready behind the local gate, and skip/rescan plus post-state counts are preserved. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 136 tests; no executor implementation, API behavior, or SLA compiler behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `ready_batch_rescan_local_gate_keeps_second_local_ready_after_skip` passed 1/1 with `--jobs 1` and a 90s timeout; focused default backend filter `ready_batch_rescan` passed 7/7 with a 120s timeout; focused SA backend filter `ready_batch_rescan` passed 7/7 serially with a 180s timeout; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6817 tests-dir `@test` annotations, and 7453 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor ready-batch rescan local-gate coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep initial-skip handling for running systems. `ecs_executor_initial_skips_summary_deep3` now ignores skip-list entries that refer to already running systems instead of marking them skipped/completed, and `mt_deep_initial_skips_summary_ignores_running_systems` proves a running system is ignored while a separate ready system in the same skip list is still skipped. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 137 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `initial_skips_summary_ignores_running_systems` passed 1/1 with `--jobs 1` and a 90s timeout; focused default backend filter `initial_skip` passed 7/7 with a 120s timeout; focused SA backend filter `initial_skip` passed 7/7 serially with a 180s timeout; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6818 tests-dir `@test` annotations, and 7454 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor initial-skip running-system guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep dependent-release handling for already running systems. `ecs_executor_state_deep_release_dependent` now clears dependency counts without marking a running dependent ready, and `mt_deep_initial_skips_summary_release_keeps_running_dependent_unready` proves skip-driven release keeps the running dependent out of the ready queue. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 138 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `initial_skips_summary_release_keeps_running_dependent_unready` passed 1/1 with `--jobs 1` and a 90s timeout; focused default backend filter `initial_skip` passed 8/8 with a 120s timeout; focused SA backend filter `initial_skip` passed 8/8 serially with a 180s timeout after waiting for another SA test process to finish; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6819 tests-dir `@test` annotations, and 7455 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor dependent-release running guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep mark-ready handling for already running and skipped-pending systems. `ecs_executor_state_deep_mark_ready` now preserves those states without adding ready entries, and `mt_deep_mark_ready_ignores_running_system` plus `mt_deep_mark_ready_ignores_skipped_pending_system` cover both guard cases. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 140 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; focused default backend filter `mark_ready` passed 2/2 with a 90s timeout; focused default backend filter `state` passed 12/12 with a 120s timeout after an earlier regex-style filter matched 0 tests and was not counted; focused SA backend filter `mark_ready` passed 2/2 serially with a 180s timeout after waiting for other SA test processes to finish; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6821 tests-dir `@test` annotations, and 7457 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor mark-ready running/skipped guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep skip handling for already running systems. `ecs_executor_state_deep_skip_system` now ignores running systems instead of marking them skipped/completed while still running, and `ecs_executor_state_deep_mark_skipped_pending` now ignores running systems as well. `mt_deep_skip_system_ignores_running_system` and `mt_deep_mark_skipped_pending_ignores_running_system` cover both guards. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 142 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `skip_system_ignores_running_system` passed 1/1 with a 90s timeout; focused default backend filter `mark_skipped_pending` passed 2/2 with a 90s timeout; focused default backend filter `skip` passed 30/30 with a 120s timeout and a clean exit after PASS output; focused SA backend filter `mark_skipped_pending` passed 2/2 and exact filter `skip_system_ignores_running_system` passed 1/1 serially with 180s timeouts; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6823 tests-dir `@test` annotations, and 7459 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor skip running guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep complete handling for systems that are not running. `ecs_executor_state_deep_complete_system` now ignores non-running systems instead of marking them completed/unapplied, and `ecs_executor_state_deep_complete_system_with_dependents3` now avoids releasing dependents for that invalid no-op completion. `mt_deep_complete_system_ignores_not_running_system` and `mt_deep_complete_with_dependents_ignores_not_running_system` cover both direct and dependent-release paths. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 144 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filters `complete_system_ignores` and `complete_with_dependents_ignores` each passed 1/1 with 90s timeouts; focused SA backend exact filters `complete_system_ignores` and `complete_with_dependents_ignores` each passed 1/1 serially with 180s timeouts; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6825 tests-dir `@test` annotations, and 7461 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor complete running guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep skip no-op dependent-release handling. `ecs_executor_state_deep_skip_system` now ignores completed and already skipped systems, and `ecs_executor_state_deep_skip_system_with_dependents3` now avoids releasing dependents for invalid no-op, running, completed, or already skipped inputs. `mt_deep_skip_system_ignores_completed_system`, `mt_deep_skip_with_dependents_ignores_running_system`, and `mt_deep_skip_with_dependents_ignores_completed_system` cover the direct and dependent-release paths. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 147 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend focused filters `skip_system_ignores` and `skip_with_dependents_ignores` each passed 2/2 with 100s timeouts; focused SA backend filters `skip_system_ignores` and `skip_with_dependents_ignores` each passed 2/2 serially with 180s timeouts; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6828 tests-dir `@test` annotations, and 7464 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor skip no-op release guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep skipped spawn handling. `ecs_executor_state_deep_mark_skipped_pending` now clears stale ready bits, `ecs_executor_state_deep_can_spawn_system` rejects skipped systems explicitly, and direct `ecs_executor_state_deep_start_system` calls ignore skipped or completed systems. `mt_deep_mark_skipped_pending_clears_ready_and_blocks_spawn`, `mt_deep_failed_system_condition_clears_ready_and_blocks_spawn`, and `mt_deep_start_system_ignores_skipped_pending_system` cover pending-skip, failed-condition, and direct-start paths. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 150 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend focused filter `skipped_pending` passed 5/5, exact filter `failed_system_condition_clears` passed 1/1, and focused filter `state` passed 12/12 with timeout-bounded `--jobs 1`; focused SA backend filter `skipped_pending` passed 5/5 and exact filter `failed_system_condition_clears` passed 1/1 serially with 180s timeouts; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6831 tests-dir `@test` annotations, and 7467 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor skipped spawn guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep dependency-gated spawn handling. `ecs_executor_state_deep_set_dependencies` now clears stale ready state when a positive dependency count is installed, `ecs_executor_state_deep_can_spawn_system` rejects unresolved dependencies explicitly, and direct `ecs_executor_state_deep_start_system` calls ignore dependency-blocked systems. `mt_deep_set_dependencies_clears_stale_ready_and_blocks_spawn` and `mt_deep_start_system_ignores_dependency_blocked_system` cover stale-ready and direct-start paths. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 152 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend focused filter `dependencies` passed 3/3, exact filter `dependency_blocked_system` passed 1/1, and focused filter `state` passed 12/12 with timeout-bounded `--jobs 1`; focused SA backend filter `dependencies` passed 3/3 and exact filter `dependency_blocked_system` passed 1/1 serially with 180s timeouts after waiting for external SA tests to finish; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6833 tests-dir `@test` annotations, and 7469 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor dependency spawn guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep zero-dependency release handling. `ecs_executor_state_deep_release_dependent` now creates ready state only when a positive dependency count is decremented to zero; already-zero entries remain no-op inputs for direct release and completion-with-dependents paths. `mt_deep_release_dependent_ignores_zero_dependency_system` and `mt_deep_complete_with_dependents_ignores_zero_dependency_entry` cover both paths. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 154 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend focused filter `release_dependent` passed 2/2, exact filter `ignores_zero_dependency_entry` passed 1/1, and focused filter `with_dependents` passed 6/6 with timeout-bounded `--jobs 1`; focused SA backend filter `release_dependent` passed 2/2 and exact filter `ignores_zero_dependency_entry` passed 1/1 serially with 180s timeouts; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6835 tests-dir `@test` annotations, and 7471 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor zero-dependency release guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep complete-ready-batch no-op summary accounting. `ecs_executor_complete_ready_batch_summary_deep3` now records started slots only after a selected system actually enters running state and records completed slots only for systems that are running at completion time. Dependency-blocked and skipped selected inputs therefore remain no-op summary entries. `mt_deep_complete_ready_batch_summary_ignores_dependency_blocked_selected` and `mt_deep_complete_ready_batch_summary_ignores_skipped_selected` cover both invalid states. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 156 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend focused filter `complete_ready_batch_summary_ignores` passed 2/2 and focused filter `complete_ready_batch` passed 10/10 with timeout-bounded `--jobs 1` and a clean exit after PASS output; focused SA backend filter `complete_ready_batch_summary_ignores` passed 2/2 serially with a 180s timeout after waiting for external SA/SAB tests to finish; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6837 tests-dir `@test` annotations, and 7473 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor complete-ready no-op summary accounting 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep pending-skip finalization. `ecs_executor_state_deep_skip_system` and `ecs_executor_state_deep_skip_system_with_dependents3` now distinguish pending skip (`skipped=true`, `completed=false`) from terminal skipped state, allowing pending skips to be finalized and release dependents while remaining unspawnable. `ecs_executor_state_deep_drive_one_summary` now handles pending skip before `can_spawn`, so a pending skip is not reported as stalled. `mt_deep_skip_with_dependents_finalizes_pending_skip` and `mt_deep_drive_one_finalizes_pending_skip_and_releases` cover direct and drive-one paths. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 158 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend focused filters `pending_skip`, `skip_with_dependents`, and `drive_one` passed 2/2, 4/4, and 4/4 respectively with timeout-bounded `--jobs 1` and clean exits; focused SA backend filter `pending_skip` passed 2/2 serially with a 180s timeout after waiting for external SAB tests to finish; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6839 tests-dir `@test` annotations, and 7475 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep integration pending-skip finalization. Integration ready-batch selection now rejects skipped-pending and dependency-blocked systems as spawn candidates, while `ecs_executor_drive_ready_batch_integration_summary_deep3` and `ecs_executor_drive_all_batched_integration_summary_deep3` finalize pending skips before normal selection so released dependents can run in the same scan/wave. `mt_deep_drive_ready_batch_integration_finalizes_pending_skip` and `mt_deep_drive_all_batched_integration_finalizes_pending_skip` cover both integration paths. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 160 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend focused filters `integration_finalizes_pending_skip`, `drive_ready_batch_integration`, and `drive_all_batched_integration` passed 2/2, 8/8, and 9/9 respectively with timeout-bounded `--jobs 1` and clean exits; focused SA backend filter `integration_finalizes_pending_skip` passed 2/2 serially with a 180s timeout after checking for external SA/SAB tests; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6841 tests-dir `@test` annotations, and 7477 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor integration pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep ready-batch rescan pending-skip finalization. `ecs_executor_ready_batch_rescan_summary_deep3` now finalizes pending skips before ordinary ready selection, so a skipped-pending system does not need stale ready state to complete and release dependents; the rescan then selects newly released work in the same modeled batch. `mt_deep_ready_batch_rescan_finalizes_pending_skip` covers the rescan path. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 161 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `ready_batch_rescan_finalizes_pending_skip` passed 1/1 and focused filter `ready_batch_rescan` passed 8/8 with timeout-bounded `--jobs 1` and clean exits; focused SA backend exact filter `ready_batch_rescan_finalizes_pending_skip` passed 1/1 serially with a 180s timeout after waiting for external SA tests; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6842 tests-dir `@test` annotations, and 7478 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor ready-batch rescan pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep tick-with-completions pending-skip finalization. `ecs_executor_tick_with_completions_summary_deep3` now finalizes pending skips before ordinary ready selection in its post-drain rescan loop, so completion drain plus pending-skip release can select newly released work in the same modeled tick. `mt_deep_tick_with_completions_summary_finalizes_pending_skip` covers the tick-with-completions path. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 162 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `tick_with_completions_summary_finalizes_pending_skip` passed 1/1 and focused filter `tick_with_completions_summary` passed 7/7 with timeout-bounded `--jobs 1` and clean exits; focused SA backend exact filter `tick_with_completions_summary_finalizes_pending_skip` passed 1/1 serially with a 180s timeout after waiting for external SAB tests; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6843 tests-dir `@test` annotations, and 7479 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor tick-with-completions pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep run-history pending-skip classification. `ecs_executor_run_history_deep_drive_one` now records pending skips as skipped before the `can_spawn` gate, avoiding a false stalled history entry while preserving history-only, non-mutating semantics. `mt_deep_run_history_drive_one_records_pending_skip` covers the drive-one history path. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 163 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `run_history_drive_one_records_pending_skip` passed 1/1 and focused filter `run_history_drive` passed 3/3 with timeout-bounded `--jobs 1` and clean exits; focused SA backend exact filter `run_history_drive_one_records_pending_skip` passed 1/1 serially with a 180s timeout after waiting for external SA tests; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6844 tests-dir `@test` annotations, and 7480 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor run-history pending-skip classification 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep no-drain tick pending-skip finalization. `ecs_executor_tick_with_completions_summary_deep3` now preserves the existing fast no-drain ready-batch path for ordinary states, but when `done_count == 0` and a pending skip exists it falls through to the rescan/finalization path so the skipped-pending system is counted as skipped, completed, releases dependents, and selects newly released work in the same tick. `mt_deep_tick_with_completions_no_drain_finalizes_pending_skip` covers this no-drain branch. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 164 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_tick_with_completions_no_drain_finalizes_pending_skip` passed 1/1 and focused filter `tick_with_completions_summary` passed 7/7 with timeout-bounded `--jobs 1` and clean exits. SA backend exact filter was not started because another SA backend test process was already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6845 tests-dir `@test` annotations, and 7481 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor no-drain tick pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep drive-ready-batch pending-skip summary finalization. `ecs_executor_state_deep_drive_ready_batch_summary3` now finalizes skipped-pending systems before ordinary ready-batch selection, counting them as skipped/completed without attempting dependent release because this summary helper has no dependent-list inputs. `mt_deep_drive_ready_batch_summary_finalizes_pending_skip` covers the summary branch and proves a pending skip no longer causes false stall while a separate ready system is still selected. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 165 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_ready_batch_summary_finalizes_pending_skip` passed 1/1 and focused filter `drive_ready_batch_summary` passed 2/2 with timeout-bounded `--jobs 1` and clean exits. SA backend exact filter was not started because another SA backend test process was already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6846 tests-dir `@test` annotations, and 7482 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch pending-skip summary finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep zero-width drive-ready-batch pending-skip summary finalization. `ecs_executor_state_deep_drive_ready_batch_summary3` now finalizes skipped-pending systems before the `max_width <= 0` early return, preserving zero-width behavior for ordinary ready work while still counting pending skip finalization because it does not consume batch width. `mt_deep_drive_ready_batch_summary_zero_width_finalizes_pending_skip` covers the zero-width branch and proves the summary does not falsely stall or select ready work. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 166 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_ready_batch_summary_zero_width_finalizes_pending_skip` passed 1/1 and focused filter `drive_ready_batch_summary` passed 3/3 with timeout-bounded `--jobs 1` and clean exits; `git diff --check` passed. SA backend exact filter was not started because other SAB backend test processes were already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 524 lib modules, 249 deep lib modules, 426 test files, 249 deep isolated test files, 90 examples, 6847 tests-dir `@test` annotations, and 7483 lib/tests/examples `@test` annotations. Feature progress: multi-threaded executor zero-width drive-ready-batch pending-skip summary finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep zero-width integration/rescan pending-skip finalization. `ecs_executor_ready_batch_rescan_summary_deep3`, `ecs_executor_tick_with_completions_summary_deep3`, `ecs_executor_drive_ready_batch_integration_summary_deep3`, and `ecs_executor_drive_all_batched_integration_summary_deep3` now finalize skipped-pending systems before `max_width <= 0` early returns, preserving zero-width behavior for ordinary ready work while still completing pending skips and releasing dependents because that lifecycle transition does not consume batch width. Added `mt_deep_ready_batch_rescan_zero_width_finalizes_pending_skip`, `mt_deep_tick_with_completions_zero_width_finalizes_pending_skip`, `mt_deep_drive_ready_batch_integration_zero_width_finalizes_pending_skip`, and `mt_deep_drive_all_batched_integration_zero_width_finalizes_pending_skip`. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 170 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filters for the four new zero-width tests passed 1/1 each with timeout-bounded `--jobs 1` and clean exits. A broader default filter `zero_width_finalizes_pending_skip` timed out at 90s under concurrent external SA/SAB test load and was not counted; SA backend filters were not started because external SA/SAB backend tests were already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6851 tests-dir `@test` annotations, and 7451 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor zero-width integration/rescan pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep no-drain tick gate-state summary preservation. `_mt_tick_with_completions_no_drain_fast` now initializes `local_thread_running` and `exclusive_running` from the current executor state before overlaying newly selected systems, so a no-completion tick summary does not lose an already-running local or exclusive gate. Added `mt_deep_tick_with_completions_no_drain_preserves_existing_local_gate`, proving an existing local-running system remains visible while an additional ordinary ready system is selected. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 171 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_tick_with_completions_no_drain_preserves_existing_local_gate` passed 1/1 and focused filter `no_drain` passed 2/2 with timeout-bounded `--jobs 1` and clean exits; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6852 tests-dir `@test` annotations, and 7452 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor no-drain tick gate-state summary preservation 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep no-drain tick gate coverage with `mt_deep_tick_with_completions_no_drain_preserves_existing_exclusive_gate`. The new regression proves an already-running exclusive system remains reported through exclusive/local gate accessors, blocks additional ready selection in the no-drain fast path, and leaves ordinary ready work visible for a later tick. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 172 tests; this validates the Batch 506 gate-state preservation fix for the exclusive branch without changing executor implementation, API surface, or SLA compiler behavior. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_tick_with_completions_no_drain_preserves_existing_exclusive_gate` passed 1/1 and focused filter `no_drain` passed 3/3 with timeout-bounded `--jobs 1` and clean exits. SA backend filters were not started because an external SA backend test process was already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6853 tests-dir `@test` annotations, and 7453 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor no-drain exclusive gate summary coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep no-drain tick local gate scan coverage with `mt_deep_tick_with_completions_no_drain_existing_local_blocks_second_local`. The new regression proves an already-running local system keeps a second ready local system out of the no-drain batch while selection continues far enough to run a later ordinary ready system, and the summary keeps reporting the local-running gate. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 173 tests; this validates the Batch 506 gate-state preservation and scan behavior without changing executor implementation, API surface, or SLA compiler behavior. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_tick_with_completions_no_drain_existing_local_blocks_second_local` passed 1/1 and focused filter `no_drain` passed 4/4 with timeout-bounded `--jobs 1` and clean exits. SA backend filters were not started because an external SA backend test process was already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6854 tests-dir `@test` annotations, and 7454 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor no-drain local gate scan coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep no-drain tick width-limit coverage with `mt_deep_tick_with_completions_no_drain_width_limit_leaves_remaining_ready`. The new regression proves `max_width=1` selects only the first ready system, leaves later ready systems visible in `ready_after` and `ready_at`, and does not let unselected systems affect local/exclusive gate summary fields. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 174 tests; no executor implementation, API surface, or SLA compiler behavior changed. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_tick_with_completions_no_drain_width_limit_leaves_remaining_ready` passed 1/1 and focused filter `no_drain` passed 5/5 with timeout-bounded `--jobs 1` and clean exits. SA backend filters were not started because external SA/SAB backend tests were already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6855 tests-dir `@test` annotations, and 7455 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor no-drain width-limit ready coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep ready-batch exclusive flag propagation. `ecs_executor_state_deep_take_ready_batch3` now marks the returned batch as exclusive and local when the exclusive system is selected from the second or third candidate slot after earlier candidates are unready, matching the existing start-system semantics where exclusive execution occupies the local thread. Added `mt_deep_ready_batch_exclusive_after_unready_candidate_sets_flags`, proving the exclusive selected system stands alone and reports the correct batch flags. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 175 tests; API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_ready_batch_exclusive_after_unready_candidate_sets_flags` passed 1/1 and focused filter `mt_deep_ready_batch` passed 14/14 with timeout-bounded `--jobs 1` and clean exits. SA backend filters were not started because external SA/SAB backend tests were already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6856 tests-dir `@test` annotations, and 7456 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor ready-batch exclusive flag parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep ready-batch exclusive coverage with `mt_deep_ready_batch_third_exclusive_after_unready_candidates_sets_flags`. The new regression proves the Batch 510 flag propagation fix also covers an exclusive third candidate selected after two unready candidates, returning a one-system batch with both exclusive and local flags. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 176 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_ready_batch_third_exclusive_after_unready_candidates_sets_flags` passed 1/1 and focused filter `mt_deep_ready_batch` passed 15/15 with timeout-bounded `--jobs 1` and clean exits. SA backend filters were not started because an external SA backend test process was already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6857 tests-dir `@test` annotations, and 7457 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor ready-batch third-candidate exclusive coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-ready-batch integration exclusive coverage with `mt_deep_drive_ready_batch_integration_second_exclusive_stands_alone_after_unready`. The new regression proves that when candidate 0 is unready and candidate 1 is exclusive, the integration path runs and completes candidate 1 alone while candidate 2 remains ready for a later batch, avoiding a false stall. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 177 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_ready_batch_integration_second_exclusive_stands_alone_after_unready` passed 1/1 and focused filter `drive_ready_batch_integration` passed 10/10 with timeout-bounded `--jobs 1` and clean exits. SA backend filters were not started per memory/OOM guidance; whole-file executor-deep runs remain intentionally avoided. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6858 tests-dir `@test` annotations, and 7458 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch second-candidate exclusive integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-ready-batch integration exclusive coverage with `mt_deep_drive_ready_batch_integration_third_exclusive_stands_alone_after_unready`. The new regression proves that when candidates 0 and 1 are unready, candidate 2 can run and complete alone as an exclusive system, clears its ready flag, and does not falsely stall. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 178 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_ready_batch_integration_third_exclusive_stands_alone_after_unready` passed 1/1 and focused filter `drive_ready_batch_integration` passed 11/11 with timeout-bounded `--jobs 1` and clean exits. SA backend filters were not started per memory/OOM guidance; whole-file executor-deep runs remain intentionally avoided. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6859 tests-dir `@test` annotations, and 7459 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch third-candidate exclusive integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-all batched integration exclusive coverage with `mt_deep_drive_all_batched_integration_second_exclusive_after_unready_splits_waves`. The new regression proves that when candidate 0 is dependency-blocked and candidate 1 is exclusive, drive-all runs candidate 1 alone, releases candidate 0, then completes candidates 0 and 2 in the next wave without falsely stalling. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 179 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_all_batched_integration_second_exclusive_after_unready_splits_waves` passed 1/1 and focused filter `drive_all_batched_integration` passed 11/11 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits. SA backend exact filter was not started because an external `sa sla test src/midi.sla --test-backend sa --jobs 1 --trace-panic` process was already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6860 tests-dir `@test` annotations, and 7460 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-all second-candidate exclusive integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-all batched integration exclusive coverage with `mt_deep_drive_all_batched_integration_third_exclusive_after_unready_splits_waves`. The new regression proves that when candidates 0 and 1 are dependency-blocked and candidate 2 is exclusive, drive-all runs candidate 2 alone, releases both earlier candidates, then completes candidates 0 and 1 in the next wave without falsely stalling. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 180 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_all_batched_integration_third_exclusive_after_unready_splits_waves` passed 1/1 and focused filter `drive_all_batched_integration` passed 12/12 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits. SA/SAB backend exact filter was not started because external SAB backend processes were already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6861 tests-dir `@test` annotations, and 7461 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-all third-candidate exclusive integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-all batched integration local-gate coverage with `mt_deep_drive_all_batched_integration_second_local_after_unready_keeps_ordinary_same_wave`. The new regression proves that when candidate 0 is dependency-blocked, candidate 1 is local, and candidate 2 is ordinary ready work, drive-all runs candidates 1 and 2 in the same first wave, releases candidate 0, then completes candidate 0 in the next wave without falsely stalling. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 181 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_all_batched_integration_second_local_after_unready_keeps_ordinary_same_wave` passed 1/1 and focused filter `drive_all_batched_integration` passed 13/13 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6862 tests-dir `@test` annotations, and 7462 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-all second-candidate local gate integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-all batched integration local-gate coverage with `mt_deep_drive_all_batched_integration_third_local_after_unready_splits_waves`. The new regression proves that when candidates 0 and 1 are dependency-blocked and candidate 2 is local, drive-all runs candidate 2 in the first wave, releases both earlier candidates, then completes candidates 0 and 1 in the next wave without falsely stalling. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 182 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_all_batched_integration_third_local_after_unready_splits_waves` passed 1/1 and focused filter `drive_all_batched_integration` passed 14/14 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6863 tests-dir `@test` annotations, and 7463 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-all third-candidate local gate integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep ready-batch local-gate coverage with `mt_deep_ready_batch_second_local_after_unready_keeps_ordinary`. The new regression proves that when candidate 0 is unready, candidate 1 is local, and candidate 2 is ordinary ready work, the base ready-batch selector includes candidates 1 and 2, reports the local-thread gate, and does not mark the batch exclusive. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 183 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_ready_batch_second_local_after_unready_keeps_ordinary` passed 1/1 and focused filter `mt_deep_ready_batch` passed 16/16 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits. SA backend exact filter was not started because an external SA backend process was already running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6864 tests-dir `@test` annotations, and 7464 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor ready-batch second-candidate local gate coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep ready-batch local-gate coverage with `mt_deep_ready_batch_third_local_after_unready_candidates_sets_flags`. The new regression proves that when candidates 0 and 1 are unready and candidate 2 is local, the base ready-batch selector reports the local-thread gate, selects candidate 2, and does not mark the batch exclusive. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 184 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_ready_batch_third_local_after_unready_candidates_sets_flags` passed 1/1 and focused filter `mt_deep_ready_batch` passed 17/17 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6865 tests-dir `@test` annotations, and 7465 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor ready-batch third-candidate local gate coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-ready-batch integration local-gate coverage with `mt_deep_drive_ready_batch_integration_second_local_after_unready_keeps_ordinary`. The new regression proves that when candidate 0 is unready, candidate 1 is local, and candidate 2 is ordinary ready work, the drive-ready-batch integration path runs and completes candidates 1 and 2 in the same batch, clears their ready flags, and does not falsely stall. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 185 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_ready_batch_integration_second_local_after_unready_keeps_ordinary` passed 1/1 and focused filter `drive_ready_batch_integration` passed 12/12 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6866 tests-dir `@test` annotations, and 7466 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch second-candidate local gate integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep drive-ready-batch integration local-gate coverage with `mt_deep_drive_ready_batch_integration_third_local_after_unready_runs_local`. The new regression proves that when candidates 0 and 1 are unready and candidate 2 is local, the drive-ready-batch integration path runs and completes candidate 2, clears its ready flag, and does not falsely stall. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 186 tests; no executor implementation, API surface, or SLA compiler behavior changed in this batch. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter `mt_deep_drive_ready_batch_integration_third_local_after_unready_runs_local` passed 1/1 and focused filter `drive_ready_batch_integration` passed 13/13 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6867 tests-dir `@test` annotations, and 7467 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch third-candidate local gate integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
- [done] Fixed multi-threaded executor deep ready-batch rescan selected-count accounting. `mt_deep_ready_batch_rescan_local_after_skip_keeps_ordinary_same_batch` exposed that rescan started both a released local system and a later ordinary ready system while the summary recorded only one selected slot. `_mt_ready_batch_rescan_push_selected` now assigns by stable slot position and increments `selected_count` after the slot write, keeping summary accounting aligned with state mutation. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 187 tests; SLA compiler behavior and public API surface did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `ready_batch_rescan` passed 10/10 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6868 tests-dir `@test` annotations, and 7468 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor ready-batch rescan summary selected-count parity for local-plus-ordinary post-skip batches 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep ready-batch rescan third-slot coverage with `mt_deep_ready_batch_rescan_records_three_selected_slots`. The new regression proves three ordinary ready systems selected in one pass produce `selected_count=3`, stable selected slots 0/1/2, no remaining ready work, three running systems, and no false stall. This completes direct coverage of the third selected slot changed in Batch 522; executor implementation, public API surface, and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `ready_batch_rescan` passed 11/11 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6869 tests-dir `@test` annotations, and 7469 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor ready-batch rescan third selected-slot coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Extended multi-threaded executor deep tick-with-completions no-drain third-slot coverage with `mt_deep_tick_with_completions_no_drain_records_three_selected_slots`. The new regression proves three ordinary ready systems selected with `max_width=3` produce `selected_count=3`, stable slots 0/1/2, an out-of-bounds `-1`, zero remaining ready flags, three running systems, and no local/exclusive gate. Executor implementation, public API surface, and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `no_drain` passed 6/6 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits. SA backend exact verification was skipped because external SAB backend tests were running; whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6870 tests-dir `@test` annotations, and 7470 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor tick-with-completions no-drain third selected-slot coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep tick-with-completions completion-drain selected-slot accounting. `mt_deep_tick_with_completions_releases_and_keeps_ordinary_same_batch` exposed that completing system 0 released system 1 and state started systems 1 and 2, while the summary recorded only one selected slot. `_mt_tick_with_completions_push_selected` now assigns by stable slot position and increments `selected_count` after the slot write, matching the verified rescan fix. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 190 tests; public API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `mt_deep_tick_with_completions` passed 15/15 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6871 tests-dir `@test` annotations, and 7471 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor tick-with-completions completion-drain multi-select summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep tick-with-completions completion-drain completed-slot accounting. `mt_deep_tick_with_completions_records_two_completed_slots` exposed that one tick completed systems 0 and 1 in state while the summary recorded only one completed slot. `_mt_tick_with_completions_push_completed` now assigns by stable slot position and increments `completed_count` after the slot write, matching the selected-slot fixes. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 191 tests; public API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `mt_deep_tick_with_completions` passed 16/16 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6872 tests-dir `@test` annotations, and 7472 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor tick-with-completions completion-drain completed-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep tick-with-completions ignored-slot accounting. `mt_deep_tick_with_completions_records_two_ignored_slots` exposed that one tick saw two invalid completion ids while the summary recorded only one ignored slot. `_mt_tick_with_completions_push_ignored` now assigns by stable slot position and increments `ignored_count` after the slot write, matching the selected/completed slot fixes. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 192 tests; public API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `mt_deep_tick_with_completions` passed 17/17 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6873 tests-dir `@test` annotations, and 7473 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor tick-with-completions ignored-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep tick-with-completions skipped-slot accounting. `mt_deep_tick_with_completions_records_two_skipped_slots` reproduced panic 149922 before the fix: one tick finalized two pending skipped systems while the summary recorded only one skipped slot. `_mt_tick_with_completions_push_skipped` now assigns by stable slot position and increments `skipped_count` after the slot write, matching the selected/completed/ignored slot fixes. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 193 tests; public API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `mt_deep_tick_with_completions` passed 18/18 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6874 tests-dir `@test` annotations, and 7474 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor tick-with-completions skipped-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep tick-with-completions apply-slot accounting. `mt_deep_tick_with_completions_records_two_apply_slots` reproduced panic 149932 before the fix: completing an ApplyDeferred barrier applied two prior deferred systems in state while the summary recorded only one apply slot. `_mt_tick_with_completions_push_apply` now assigns by stable slot position and increments `apply_count` after the slot write, matching the selected/completed/ignored/skipped slot fixes. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 194 tests; public API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `mt_deep_tick_with_completions` passed 19/19 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6875 tests-dir `@test` annotations, and 7475 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor tick-with-completions apply-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep ready-batch rescan skipped-slot accounting. `mt_deep_ready_batch_rescan_records_two_skipped_slots` reproduced panic 149940 before the fix: one rescan finalized two pending skipped systems while the summary recorded only one skipped slot. `_mt_ready_batch_rescan_push_skipped` now assigns by stable slot position and increments `skipped_count` after the slot write, matching the selected-slot fix and the tick-with-completions slot fixes. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 195 tests; public API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `ready_batch_rescan` passed 12/12 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6876 tests-dir `@test` annotations, and 7476 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor ready-batch rescan skipped-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep complete-ready-batch apply-slot accounting. `mt_deep_complete_ready_batch_records_two_apply_slots` reproduced panic 149948 before the fix: one complete-ready batch completed two deferred systems and an ApplyDeferred barrier while the summary recorded only one apply slot. `_mt_complete_ready_batch_push_apply` now assigns by stable slot position and increments `apply_count` after the slot write, matching the tick-with-completions apply fix. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 196 tests; public API surface and SLA compiler behavior did not change. Verification: existing focused filter `complete_ready_batch` passed 10/10 before the new regression, so already-covered started/completed paths were not changed; lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `complete_ready_batch` passed 11/11 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6877 tests-dir `@test` annotations, and 7477 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor complete-ready-batch apply-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep drive-ready-batch integration apply-slot accounting. `mt_deep_drive_ready_batch_integration_records_two_apply_slots` reproduced panic 149959 before the fix: one drive-ready batch ran an ApplyDeferred barrier while two prior deferred systems were unapplied, and the summary recorded only one apply slot. `_mt_drive_ready_batch_integration_push_apply` now assigns by stable slot position and increments `apply_count` after the slot write, matching the complete-ready and tick-with-completions apply fixes. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 197 tests; public API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `drive_ready_batch_integration` passed 14/14 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6878 tests-dir `@test` annotations, and 7478 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch integration apply-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep drive-all batched integration apply-slot accounting. `mt_deep_drive_all_batched_integration_records_two_apply_slots` reproduced panic 149972 before the fix: one drive-all batch ran an ApplyDeferred barrier while two prior deferred systems were unapplied, and the summary recorded only one apply slot. `_mt_drive_all_batched_push_apply` now assigns by stable slot position and increments `apply_count` after the slot write, matching the drive-ready, complete-ready, and tick-with-completions apply fixes. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 198 tests; public API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `drive_all_batched_integration` passed 15/15 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6879 tests-dir `@test` annotations, and 7479 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-all batched integration apply-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Fixed multi-threaded executor deep drive-ready-batch integration zero-width skipped-slot accounting. `mt_deep_drive_ready_batch_integration_zero_width_records_two_skipped_slots` reproduced panic 149980 before the fix: `max_width=0` finalized two pending skipped systems while the summary recorded only one skipped slot. `_mt_drive_ready_batch_integration_push_skipped` now assigns by stable slot position and increments `skipped_count` after the slot write, matching the ready-batch rescan and tick-with-completions skipped fixes. `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` now has 199 tests; public API surface and SLA compiler behavior did not change. Verification: lib/test `sa sla check` passed with 45s timeouts; default backend exact filter passed 1/1 and focused filter `drive_ready_batch_integration` passed 15/15 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; SA backend exact filter was not started because an external `sa sla test tests/test_compiler_contract.sla --test-backend sa --jobs 1 --trace-panic` process was already running; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6880 tests-dir `@test` annotations, and 7480 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-ready-batch integration zero-width skipped-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.

- [done] Added multi-threaded executor deep drive-all batched zero-width skipped-slot coverage with `mt_deep_drive_all_batched_integration_zero_width_records_two_skipped_slots`. The regression proves `max_width=0` finalizes two pending skipped systems, reports both skipped slots in stable order, returns `-1` out of bounds, records one zero-width wave and zero runs, reaches the expected completed/ready state, and does not falsely stall. The existing executor implementation already behaves correctly; no executor implementation, public API surface, or SLA compiler behavior changed. Verification: test-file `sa sla check` passed with a 45s timeout; default backend exact filter passed 1/1 and focused filter `drive_all_batched_integration` passed 16/16 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean exits; serial SA backend exact filter passed 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`; `git diff --check` passed. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance. Current measured counts are 521 lib `.sla` modules, 249 deep lib modules, 425 test `.sla` files, 249 deep isolated test files, 90 examples, 6881 tests-dir `@test` annotations, and 7481 lib/tests/examples `.sla` `@test` annotations. Feature progress: multi-threaded executor drive-all batched integration zero-width skipped-slot coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
