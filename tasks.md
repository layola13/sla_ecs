...
- [x] Add verified generic relationship runtime example: `examples/relationship_runtime_demo.sla`, covering many relationships, one-to-one replacement, self-reference policy, and linked recursive despawn. Verification: `SA_PLUGIN_DEV=1 sa sla test examples/relationship_runtime_demo.sla`.
