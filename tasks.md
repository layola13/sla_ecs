...
# Batch 438 - `lib/executor_multi_threaded_deep.sla` tick-loop skipped-batch accessor parity (DONE 2026-07-14)
- [x] Extended `EcsExecutorTickLoopSummaryDeep` with flat skipped-count/id slots for the first two tick-loop batches and added `ecs_executor_tick_loop_summary_deep_batch_skipped_count` / `ecs_executor_tick_loop_summary_deep_batch_skipped_at` accessors.
- [x] Routed tick-loop no-completion and two-completion wave summaries through the ready-batch rescan summary so skipped ids are preserved with selected systems.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 86 to 88 tests, adding 2 focused skipped-accessor tests for first-wave and second-wave skipped systems.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "skipped_accessors" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "skipped_accessors" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor tick-loop skipped-batch accessor parity sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94-96%, behavioral parity remains ~86-91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6769 tests-dir `@test` annotations | 7405 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 439 - `lib/executor_multi_threaded_deep.sla` condition-fold/run-history accessor parity (DONE 2026-07-14)
- [x] Added read-only condition-fold accessors for `should_run`, `evaluated_count`, and `aborted`, mirroring the shallow condition-fold accessor surface.
- [x] Added read-only run-history accessors for run/apply/skipped counts and stalled state, complementing the existing count-aware `_at` helpers.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 88 to 90 tests, adding 2 focused accessor-parity tests for condition folds and run history.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "accessor_parity" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "accessor_parity" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor condition-fold/run-history accessor parity sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6771 tests-dir `@test` annotations | 7407 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 440 - `lib/executor_multi_threaded_deep.sla` error-state and condition-error accessor parity (DONE 2026-07-14)
- [x] Added read-only error-state accessors for panic payload pending/state, panic payload rethrows, system/deferred panic counts, and handled-error phase/system fields.
- [x] Added read-only condition-fold accessors for panic payload and handled-error metadata alongside the existing should-run/evaluated/aborted accessors.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 90 to 92 tests, adding 2 focused accessor-parity tests for error-state and condition-fold error fields.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "error_accessor_parity" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "error_accessor_parity" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor error-state and condition-error accessor parity sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6773 tests-dir `@test` annotations | 7409 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 441 - `lib/executor_multi_threaded_deep.sla` completed-tick error summary accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorCompletedTickErrorSummaryDeep` tick/lock/pending/selected/skipped/apply/post-state/error metadata.
- [x] Added count-aware pending/selected/skipped `_at` helpers that return `-1` out of bounds.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 92 to 94 tests, adding 2 focused accessor tests for panic and handled-error completed-tick summaries.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "completed_tick_error_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "completed_tick_error_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor completed-tick error accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6775 tests-dir `@test` annotations | 7411 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 442 - `lib/executor_multi_threaded_deep.sla` complete-ready-batch summary accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorCompleteReadyBatchSummaryDeep` started/completed/apply counts and slots, post-batch ready/running/completed/unapplied counts, and local/exclusive gate metadata.
- [x] Added count-aware `started_at`, `completed_at`, and `apply_at` helpers that return `-1` out of bounds.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 94 to 96 tests, adding 2 focused accessor tests for started/completed summaries and ApplyDeferred barrier accounting.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "complete_ready_batch_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "complete_ready_batch_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor complete-ready-batch accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6777 tests-dir `@test` annotations | 7413 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 443 - `lib/executor_multi_threaded_deep.sla` initial-skip summary accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorInitialSkipsSummaryDeep` skipped/ignored counts and slots, post-skip ready/completed/skipped counts, dependency counters, and ready flags.
- [x] Added count-aware skipped/ignored `_at` helpers that return `-1` out of bounds, plus fixed system-index dependency/ready helpers that return `-1`/`false` out of range.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 96 to 98 tests, adding 2 focused accessor tests for skipped/ignored accounting and dependency/ready slots.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "initial_skip_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "initial_skip_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor initial-skip accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6779 tests-dir `@test` annotations | 7415 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 444 - `lib/executor_multi_threaded_deep.sla` completion-queue drain summary accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorCompletionQueueDrainSummaryDeep` completed/ignored/apply counts and slots, post-drain ready/running/completed/unapplied counts, local/exclusive gate metadata, dependency counters, and ready flags.
- [x] Added count-aware completed/ignored/apply `_at` helpers that return `-1` out of bounds, plus fixed system-index dependency/ready helpers that return `-1`/`false` out of range.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 98 to 100 tests, adding 2 focused accessor tests for completion/ignored accounting and ApplyDeferred/dependency/gate metadata.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "completion_queue_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "completion_queue_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor completion-queue drain accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6781 tests-dir `@test` annotations | 7417 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 445 - `lib/executor_multi_threaded_deep.sla` tick-with-completions summary accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorTickWithCompletionsSummaryDeep` completed/ignored/apply/selected/skipped counts and slots, post-tick ready/running/completed/unapplied counts, stalled state, local/exclusive gate metadata, dependency counters, and ready flags.
- [x] Added count-aware completed/ignored/apply/selected/skipped `_at` helpers that return `-1` out of bounds, plus fixed system-index dependency/ready helpers that return `-1`/`false` out of range.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 100 to 102 tests, adding 2 focused accessor tests for selected bounds and skip/rescan dependency state.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "tick_with_completion_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "tick_with_completion_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor tick-with-completions accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6783 tests-dir `@test` annotations | 7419 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 446 - `lib/executor_multi_threaded_deep.sla` drive-ready-batch integration accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorDriveReadyBatchIntegrationSummaryDeep` run/completed/skipped/apply counts and slots, post-drive ready/running/completed/unapplied counts, stalled state, dependency counters, and ready flags.
- [x] Added count-aware run/completed/skipped/apply `_at` helpers that return `-1` out of bounds, plus fixed system-index dependency/ready helpers that return `-1`/`false` out of range.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 102 to 104 tests, adding 2 focused accessor tests for width-limited run/completion and skip-released ApplyDeferred dependency state.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "drive_ready_batch_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "drive_ready_batch_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-ready-batch integration accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6785 tests-dir `@test` annotations | 7421 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 447 - `lib/executor_multi_threaded_deep.sla` drive-all-batched integration accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorDriveAllBatchedIntegrationSummaryDeep` wave count, run/completed/skipped/apply counts and slots, post-drive ready/running/completed/unapplied counts, stalled state, and dependency counters.
- [x] Added count-aware run/completed/skipped/apply `_at` helpers that return `-1` out of bounds, plus fixed system-index dependency helpers that return `-1` out of range.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 104 to 106 tests, adding 2 focused accessor tests for multi-wave completion and skip-released ApplyDeferred state.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "drive_all_batched_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "drive_all_batched_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-all-batched integration accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6787 tests-dir `@test` annotations | 7423 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 448 - `lib/executor_multi_threaded_deep.sla` ready-batch rescan accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorReadyBatchRescanSummaryDeep` selected/skipped counts and slots, rescan count, post-rescan ready/completed/running counts, and stalled state.
- [x] Added count-aware selected/skipped `_at` helpers that return `-1` out of bounds.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 106 to 108 tests, adding 2 focused accessor tests for skip+select rescan bounds and zero-width stalled state.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "ready_batch_rescan_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "ready_batch_rescan_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch rescan accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6789 tests-dir `@test` annotations | 7425 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 449 - `lib/executor_multi_threaded_deep.sla` begin-run summary accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorBeginRunSummaryDeep` ready count/flags, dependency counters, transient reset counts, unapplied preservation count, gate reset state, history counts, stalled state, and panic/handled-error metadata.
- [x] Added fixed system-index `ready_at` and `dependencies_at` helpers that return `false`/`-1` out of range.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 108 to 110 tests, adding 2 focused accessor tests for ready/dependency bounds and preserved-unapplied/error-reset metadata.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "begin_run_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "begin_run_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor begin-run accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6791 tests-dir `@test` annotations | 7427 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 450 - `lib/executor_multi_threaded_deep.sla` finish-run summary accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorFinishRunSummaryDeep` final-deferred enablement, apply count, post-finish state cleanup counts, panic payload metadata, and deferred handled-error metadata.
- [x] Boolean accessors return `bool`; scalar phase/system/count helpers mirror the existing flat summary fields without changing finish-run write paths.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 110 to 112 tests, adding 2 focused accessor tests for disabled-final-deferred preservation and deferred panic/handled-error metadata.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "finish_run_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "finish_run_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor finish-run accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6793 tests-dir `@test` annotations | 7429 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 451 - `lib/executor_multi_threaded_deep.sla` drive summary accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorDriveSummaryDeep` selected slots, skipped/apply/completed/ready/unapplied counts, stalled state, lock failure, and pending-completion slots.
- [x] Added count-aware selected/pending `_at` helpers that return `-1` out of bounds and bool helpers for stalled/lock-failed flags.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 112 to 114 tests, adding 2 focused accessor tests for selected bounds, skip/apply accounting, and lock-failed pending metadata.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "drive_summary_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "drive_summary_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive summary accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6795 tests-dir `@test` annotations | 7431 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 452 - `lib/executor_multi_threaded_deep.sla` system spec accessors (DONE 2026-07-14)
- [x] Added read-only accessors for `EcsExecutorSystemSpecDeep` system index, exclusive/local flags, deferred/should-run/apply-deferred flags, and access-conflict metadata.
- [x] Added count-aware two-slot conflict accessors that return `-1` out of bounds while preserving the fixed-cap construction behavior.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 114 to 116 tests, adding 2 focused accessor tests for system spec flags and conflict bounds.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "system_spec_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "system_spec_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor system spec accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6797 tests-dir `@test` annotations | 7433 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 453 - `lib/executor_multi_threaded_deep.sla` state metadata accessors (DONE 2026-07-14)
- [x] Added read-only accessors for the multi-threaded deep executor cap plus `EcsExecutorStateDeep` system and set counts.
- [x] Kept initialization/clamping and all state slot mutation behavior unchanged; the new helpers only expose existing metadata.
- [x] tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla: expanded from 116 to 118 tests, adding 2 focused accessor tests for upper and lower clamp metadata.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "state_metadata_accessor" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "state_metadata_accessor" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor state metadata accessor sub-surface 0% -> 100% for the flat fixed-arity model; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 454 - `executor_multi_threaded_deep` isolated accessor usage cleanup (DONE 2026-07-14)
- [x] Migrated early direct-field assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing public accessors for state metadata, ready-batch count/flags, and system-spec drive flags.
- [x] Kept executor implementation, API surface, and test count unchanged; remaining direct `should_run` assertions are condition-fold result checks and remain a separate surface.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; focused default backend filters `state_init`, `ready_batch`, `tick_after_completion`, and `system_spec_drive_flags` pass with `--jobs 1` and timeouts; focused SA backend exact test-name filters pass serially for all six edited tests with `--jobs 1` and `timeout 180s`; `git diff --check` passes. A concurrent SA backend attempt timed out without panic output and was replaced by serial exact-filter verification to avoid memory/resource contention.
- [x] Feature progress: multi-threaded executor isolated accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: condition-fold result accessor cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 455 - `executor_multi_threaded_deep` condition-fold accessor usage cleanup (DONE 2026-07-14)
- [x] Migrated early condition-fold result assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_condition_fold_deep_*` accessors.
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "condition_fold_" --jobs 1 --trace-panic` passes 6; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "condition_fold_" --jobs 1 --trace-panic` passes 6; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor condition-fold accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: error-state and summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 456 - `executor_multi_threaded_deep` error-state accessor usage cleanup (DONE 2026-07-14)
- [x] Migrated early error-state result assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_error_state_deep_*` accessors.
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "error_state_records" --jobs 1 --trace-panic` passes 2; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "error_state_records" --jobs 1 --trace-panic` passes 2; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor error-state accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 457 - `executor_multi_threaded_deep` finish-run summary accessor usage cleanup (DONE 2026-07-14)
- [x] Migrated early finish-run summary assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_finish_run_summary_deep_*` accessors.
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "finish_run_summary" --jobs 1 --trace-panic` passes 4; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "finish_run_summary" --jobs 1 --trace-panic` passes 4; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor finish-run summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
...
# Batch 475 - `executor_multi_threaded_deep` drive-ready-batch ApplyDeferred dependent release (DONE 2026-07-15)
- [x] Added `mt_deep_drive_ready_batch_integration_apply_deferred_releases_dependent` to cover a prior completed deferred system, a ready `ApplyDeferred` barrier, and the dependent ordinary system released by the barrier into the ready queue for a later batch.
- [x] Asserted single barrier run, apply slot 0, completed barrier slot, ready-after 1, completed-after 2, final unapplied count 0, dependency count 0 for system 2, and non-stalled state; test count is now 120.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `apply_deferred_releases_dependent` passes 1, default backend focused filters `drive_ready_batch_integration` (5) and `drive_ready_batch_accessor` (2) pass with `timeout 90s` and `--jobs 1`; serial SA backend focused filters `drive_ready_batch_integration` (5) and `drive_ready_batch_accessor` (2) pass with `timeout 180s` and `--jobs 1`; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-ready-batch ApplyDeferred dependent-release integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6801 tests-dir `@test` annotations | 7437 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 476 - `executor_multi_threaded_deep` drive-all max-waves stall coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_all_batched_integration_max_waves_stalls_after_progress` to cover a capped drive-all run that makes one dependency-chain wave of progress, then stops at `max_waves=1` with a newly ready dependent still unrun.
- [x] Asserted stalled state, one recorded wave, run/completed slot 0, completed-after 1, ready-after 1, dependency count 0 for system 1, and dependency count 1 for system 2; test count is now 121.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `max_waves_stalls_after_progress` passes 1, default backend focused filters `drive_all_batched_integration` (6) and `drive_all_batched_accessor` (2) pass with `timeout 90s` and `--jobs 1`; serial SA backend focused filters `drive_all_batched_integration` (6) and `drive_all_batched_accessor` (2) pass with `timeout 180s` and `--jobs 1`; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-all-batched max-waves partial-progress stall coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
...
# Batch 478 - `executor_multi_threaded_deep` drive-all exclusive gate coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_all_batched_integration_exclusive_gate_splits_waves` to cover drive-all batching with one ready exclusive system and two ready ordinary systems.
- [x] Asserted the exclusive system runs alone in the first wave, ordinary systems 1 and 2 run in the second wave, final stalled state is false, and run/completed order is `0, 1, 2`; test count is now 123.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `exclusive_gate_splits_waves` passes 1, default backend focused filter `drive_all_batched_integration` passes 8 with a clean 120s rerun after an earlier 90s run printed 8/8 PASS but returned 143, default backend focused filter `drive_all_batched_accessor` (2) passes with `timeout 90s` and `--jobs 1`; serial SA backend focused filters `drive_all_batched_integration` (8) and `drive_all_batched_accessor` (2) pass with `timeout 180s` and `--jobs 1`; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-all-batched exclusive-gate wave splitting coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6804 tests-dir `@test` annotations | 7440 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 479 - `executor_multi_threaded_deep` drive-ready-batch exclusive gate coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_ready_batch_integration_exclusive_gate_stands_alone` to cover a ready-batch drive where one ready exclusive system and two ready ordinary systems are all initially ready.
- [x] Asserted the exclusive system runs and completes alone, ordinary systems 1 and 2 remain ready for a later batch, final stalled state is false, and completed-after is 1; test count is now 124.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `exclusive_gate_stands_alone` passes 1, default backend focused filters `drive_ready_batch_integration` (6) and `drive_ready_batch_accessor` (2) pass with `timeout 90s` and `--jobs 1`; serial SA backend focused filters `drive_ready_batch_integration` (6) and `drive_ready_batch_accessor` (2) pass with `timeout 180s` and `--jobs 1`; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-ready-batch exclusive-gate stand-alone coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6805 tests-dir `@test` annotations | 7441 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 480 - `executor_multi_threaded_deep` drive-ready-batch local gate coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_ready_batch_integration_local_gate_keeps_second_local_ready` to cover a ready-batch drive where two ready local systems and one ready ordinary system are all initially ready.
- [x] Asserted the first local system and ordinary system 2 run in the same batch, the second local system remains ready for a later batch, final stalled state is false, and completed-after is 2; test count is now 125.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `local_gate_keeps_second_local_ready` passes 1, default backend focused filters `drive_ready_batch_integration` (7) and `drive_ready_batch_accessor` (2) pass with `timeout 90s` and `--jobs 1`; serial SA backend focused filters `drive_ready_batch_integration` (7) and `drive_ready_batch_accessor` (2) pass with `timeout 180s` and `--jobs 1`; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-ready-batch local-gate ready-preservation coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6806 tests-dir `@test` annotations | 7442 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.
...
- [x] Preserved ApplyDeferred run-history semantics by applying pending unapplied entries from the input state before merging integration apply slots without duplicates.
- [x] Migrated the edited drive-all history tests to existing `ecs_executor_run_history_deep_*` accessors for counts and stalled state; test count remains 118.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filters `drive_all_history` (4), `drive_all_batched_accessor` (2), and `drive_all_batched_integration` (4) pass with `--jobs 1`; SA backend serial focused filters `drive_all_history` (4), `drive_all_batched_accessor` (2), and `drive_all_batched_integration` (4) pass with `timeout 180s` and `--jobs 1`; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-all history integration behavior 0% -> 100% for this focused fix; run-history accessor-usage cleanup 0% -> 100% for the edited tests; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 467 - `executor_multi_threaded_deep` ready-batch rescan accessor usage cleanup (DONE 2026-07-15)
- [x] Migrated early ready-batch rescan selected/skipped count and slot assertions, rescan-count assertion, and post-rescan ready/running/completed count assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_ready_batch_rescan_summary_deep_*` accessors.
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "ready_batch_rescan" --jobs 1 --trace-panic` passes 6; serial SA backend rerun with `timeout 180s`, `--jobs 1`, and the same filter passes 6; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch rescan accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.
...
# Batch 469 - `executor_multi_threaded_deep` initial-skip accessor usage cleanup (DONE 2026-07-15)
- [x] Migrated early initial-skip summary assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_initial_skips_summary_deep_*` accessors.
- [x] Covered skipped/ignored counts and slots, post-skip ready/completed/skipped counts, dependency counters, and ready flags; test count remains 118.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "initial_skip" --jobs 1 --trace-panic` passes 6; serial SA backend rerun with `timeout 180s`, `--jobs 1`, and the same filter passes 6; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor initial-skip accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 470 - `executor_multi_threaded_deep` completion-queue accessor usage cleanup (DONE 2026-07-15)
- [x] Migrated early completion-queue drain summary assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_completion_queue_drain_summary_deep_*` accessors.
- [x] Covered completed/ignored/apply counts and slots, post-drain ready/running/completed/unapplied counts, dependency counters, ready flags, and local/exclusive gate assertions; test count remains 118.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "completion_queue" --jobs 1 --trace-panic` passes 6; serial SA backend rerun with `timeout 180s`, `--jobs 1`, and the same filter passes 6; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor completion-queue accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 471 - `executor_multi_threaded_deep` tick-with-completions accessor usage cleanup (DONE 2026-07-15)
- [x] Migrated early tick-with-completions summary assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_tick_with_completions_summary_deep_*` accessors.
- [x] Covered completed/ignored/selected/skipped/apply counts and slots, post-tick ready/running/completed/unapplied counts, dependency counters, and local/exclusive gate assertions; test count remains 118.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "tick_with_completion" --jobs 1 --trace-panic` passes 6; serial SA backend rerun with `timeout 180s`, `--jobs 1`, and the same filter passes 6; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor tick-with-completions accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 472 - `executor_multi_threaded_deep` drive-ready-batch integration accessor usage cleanup (DONE 2026-07-15)
- [x] Migrated early drive-ready-batch integration summary assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_drive_ready_batch_integration_summary_deep_*` accessors.
- [x] Covered run/completed/skipped/apply counts and slots, post-drive ready/running/completed/unapplied counts, stalled state, and dependency counters; test count remains 118.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filters `drive_ready_batch_integration` (4) and `drive_ready_batch_accessor` (2) pass with `timeout 90s` and `--jobs 1`; serial SA backend reruns with `timeout 180s`, `--jobs 1`, and the same filters pass 4 and 2 respectively; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-ready-batch integration accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: drive-all-batched integration direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 473 - `executor_multi_threaded_deep` drive-all-batched integration accessor usage cleanup (DONE 2026-07-15)
- [x] Migrated early drive-all-batched integration summary assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_drive_all_batched_integration_summary_deep_*` accessors.
- [x] Covered wave/run/completed/skipped counts and slots, post-drive running/completed counts, stalled state, and dependency counters; test count remains 118.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filters `drive_all_batched_integration` (4) and `drive_all_batched_accessor` (2) pass with `timeout 90s` and `--jobs 1`; serial SA backend reruns with `timeout 180s`, `--jobs 1`, and the same filters pass 4 and 2 respectively; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-all-batched integration accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.
...
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "run_history_" --jobs 1 --trace-panic` passes 5; serial SA backend rerun with `timeout 180s`, `--jobs 1`, and the same filter passes 5; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor run-history accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 464 - `executor_multi_threaded_deep` tick-loop summary accessor usage cleanup (DONE 2026-07-15)
- [x] Migrated early tick-loop two-completion-wave and retry-pending assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_tick_loop_summary_deep_*` accessors.
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "tick_loop_two_completion_waves" --jobs 1 --trace-panic` passes 1; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "tick_loop_retry_pending" --jobs 1 --trace-panic` passes 1; serial SA backend reruns with `timeout 180s`, `--jobs 1`, and the same two filters each pass 1; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor tick-loop summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.
...
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "lock_failed_summaries" --jobs 1 --trace-panic` passes 1; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "lock_failed_summaries" --jobs 1 --trace-panic` passes 1; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor lock-failed drive summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 461 - `executor_multi_threaded_deep` drive-ready-batch summary accessor usage cleanup (DONE 2026-07-14)
- [x] Migrated the early drive-ready-batch summary assertion in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_drive_summary_deep_*` accessors.
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "drive_ready_batch_summary" --jobs 1 --trace-panic` passes 1; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "drive_ready_batch_summary" --jobs 1 --trace-panic` passes 1; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-ready-batch summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 458 - `executor_multi_threaded_deep` begin-run summary accessor usage cleanup (DONE 2026-07-14)
- [x] Migrated early begin-run summary assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_begin_run_summary_deep_*` accessors.
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "begin_run_summary" --jobs 1 --trace-panic` passes 4; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "begin_run_summary" --jobs 1 --trace-panic` passes 4; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor begin-run summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 459 - `executor_multi_threaded_deep` completed-tick error summary accessor usage cleanup (DONE 2026-07-14)
- [x] Migrated early completed-tick error summary assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_completed_tick_error_summary_deep_*` accessors.
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "completed_tick_error_" --jobs 1 --trace-panic` passes 6; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "completed_tick_error_" --jobs 1 --trace-panic` passes 6; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor completed-tick error summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 460 - `executor_multi_threaded_deep` drive-one summary accessor usage cleanup (DONE 2026-07-14)
- [x] Migrated early drive-one summary assertions in `tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla` to existing `ecs_executor_drive_summary_deep_*` accessors.
- [x] Kept executor implementation, API surface, and test count unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; `timeout 90s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --filter "drive_one_" --jobs 1 --trace-panic` passes 3; `timeout 150s env SA_PLUGIN_DEV=1 sa sla test tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla --test-backend sa --filter "drive_one_" --jobs 1 --trace-panic` passes 3; `git diff --check` passes. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-one summary accessor-usage cleanup 0% -> 100% for this test-maintenance slice; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: unchanged at 524 lib modules | 249 `*_deep.sla` modules | 425 test files | 249 `*_deep_isolated.sla` files | 90 examples | 6799 tests-dir `@test` annotations | 7435 lib/tests/examples `@test` annotations. Remaining optional depth: other summary-result direct-field cleanup or broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 481 - `executor_multi_threaded_deep` tick-loop no-completion gate coverage (DONE 2026-07-15)
- [x] Added `mt_deep_tick_loop_no_completion_exclusive_gate_stands_alone`, proving the tick-loop no-completion summary reports only the exclusive system in the first batch when ordinary systems are also ready.
- [x] Added `mt_deep_tick_loop_no_completion_local_gate_keeps_second_local_ready`, proving the same tick-loop path runs one local system plus an ordinary system while keeping the second local system out of the batch.
- [x] Kept executor implementation, API surface, and SLA compiler unchanged; this was a focused coverage gap, not a compiler issue.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filters `tick_loop_no_completion_exclusive_gate_stands_alone` and `tick_loop_no_completion_local_gate_keeps_second_local_ready` each pass 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `tick_loop_no_completion` passes 3/3 with `timeout 120s` and `--jobs 1`; serial SA backend focused filter `tick_loop_no_completion` passes 3/3 with `timeout 180s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor no-completion tick-loop gate summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6808 tests-dir `@test` annotations | 7444 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 482 - `executor_multi_threaded_deep` tick-loop completion gate coverage (DONE 2026-07-15)
- [x] Added `mt_deep_tick_loop_two_completion_waves_exclusive_gate_splits_batches`, proving a first completion can release an exclusive and ordinary ready pair while the tick-loop summary records the exclusive system alone in wave 0 and the ordinary system in wave 1.
- [x] Added `mt_deep_tick_loop_two_completion_waves_local_gate_splits_batches`, proving a first completion can release two local systems while the tick-loop summary splits them across the two completion waves.
- [x] Kept executor implementation, API surface, and SLA compiler unchanged; this was a focused coverage gap, not a compiler issue.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filters `tick_loop_two_completion_waves_exclusive_gate_splits_batches` and `tick_loop_two_completion_waves_local_gate_splits_batches` each pass 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `tick_loop_two_completion_waves` passes 3/3 with `timeout 120s` and `--jobs 1`; serial SA backend focused filter `tick_loop_two_completion_waves` passes 3/3 with `timeout 180s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor completion-wave tick-loop gate summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6810 tests-dir `@test` annotations | 7446 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 483 - `executor_multi_threaded_deep` tick-with-completions gate coverage (DONE 2026-07-15)
- [x] Added `mt_deep_tick_with_completions_summary_exclusive_gate_stands_alone`, proving completion-drain release selects an exclusive system alone, leaves ordinary work ready, and records both exclusive and local gate occupancy for the running exclusive system.
- [x] Added `mt_deep_tick_with_completions_summary_local_gate_keeps_second_local_ready`, proving completion-drain release selects the first local system and leaves the second local system ready.
- [x] Kept executor implementation, API surface, and SLA compiler unchanged; this was a focused coverage gap plus one corrected test expectation after confirming the existing model treats exclusive execution as local-thread occupancy.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `tick_with_completions_summary_exclusive_gate_stands_alone` passes 1/1 with `timeout 150s`, `--jobs 1`, and `--trace-panic` after an earlier 90s run exited 124 without output; default backend exact filter `tick_with_completions_summary_local_gate_keeps_second_local_ready` passes 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `tick_with_completion` passes 8/8 with `timeout 150s` and `--jobs 1`; serial SA backend focused filter `tick_with_completion` passes 8/8 with `timeout 240s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor tick-with-completions gate summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6812 tests-dir `@test` annotations | 7448 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 484 - `executor_multi_threaded_deep` completion-queue gate cleanup coverage (DONE 2026-07-15)
- [x] Added `mt_deep_completion_queue_drain_summary_local_completion_clears_gate`, proving completion-queue drain of a running local system clears the local gate and leaves no running systems.
- [x] Added `mt_deep_completion_queue_drain_summary_exclusive_completion_clears_gates`, proving completion-queue drain of a running exclusive system clears both exclusive and local gate state.
- [x] Kept executor implementation, API surface, and SLA compiler unchanged; this was a focused coverage gap, not a compiler issue.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filters `completion_queue_drain_summary_local_completion_clears_gate` and `completion_queue_drain_summary_exclusive_completion_clears_gates` each pass 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `completion_queue` passes 8/8 with `timeout 120s` and `--jobs 1`; serial SA backend focused filter `completion_queue` passes 8/8 with `timeout 240s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor completion-queue gate cleanup summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6814 tests-dir `@test` annotations | 7450 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 485 - `executor_multi_threaded_deep` complete-ready-batch gate cleanup coverage (DONE 2026-07-15)
- [x] Added `mt_deep_complete_ready_batch_summary_local_start_completion_clears_gate`, proving a fresh selected local system starts, completes, and clears local gate state in complete-ready-batch.
- [x] Added `mt_deep_complete_ready_batch_summary_exclusive_start_completion_clears_gates`, proving a fresh selected exclusive system starts, completes, and clears both exclusive and local gate state in complete-ready-batch.
- [x] Kept executor implementation, API surface, and SLA compiler unchanged; this was a focused coverage gap, not a compiler issue.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filters `complete_ready_batch_summary_local_start_completion_clears_gate` and `complete_ready_batch_summary_exclusive_start_completion_clears_gates` each pass 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `complete_ready_batch` passes 8/8 with `timeout 150s` and `--jobs 1`; serial SA backend focused filter `complete_ready_batch` passes 8/8 with `timeout 240s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor complete-ready-batch gate cleanup summary coverage 0% -> 100% for these focused scenarios; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6816 tests-dir `@test` annotations | 7452 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 486 - `executor_multi_threaded_deep` ready-batch rescan local gate coverage (DONE 2026-07-15)
- [x] Added `mt_deep_ready_batch_rescan_local_gate_keeps_second_local_ready_after_skip`, proving a skipped system can release a dependent local system during ready-batch rescan while another ready local system remains out of the same batch behind the local gate.
- [x] Kept executor implementation, API surface, and SLA compiler unchanged; this was a focused coverage gap, not a compiler issue.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `ready_batch_rescan_local_gate_keeps_second_local_ready_after_skip` passes 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `ready_batch_rescan` passes 7/7 with `timeout 120s`, `--jobs 1`, and `--trace-panic`; serial SA backend focused filter `ready_batch_rescan` passes 7/7 with `timeout 180s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch rescan local-gate coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6817 tests-dir `@test` annotations | 7453 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 487 - `executor_multi_threaded_deep` initial-skip running guard fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_initial_skips_summary_deep3` so skip-list entries for already running systems are ignored instead of being marked skipped/completed.
- [x] Added `mt_deep_initial_skips_summary_ignores_running_systems`, proving a running system remains ignored while a separate ready system in the same skip list is still skipped.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `initial_skips_summary_ignores_running_systems` passes 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `initial_skip` passes 7/7 with `timeout 120s`, `--jobs 1`, and `--trace-panic`; serial SA backend focused filter `initial_skip` passes 7/7 with `timeout 180s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor initial-skip running-system guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6818 tests-dir `@test` annotations | 7454 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 488 - `executor_multi_threaded_deep` dependent-release running guard fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_release_dependent` so a dependency release that reaches zero does not mark an already running dependent system ready.
- [x] Added `mt_deep_initial_skips_summary_release_keeps_running_dependent_unready`, proving skip-driven dependent release clears dependency count but keeps a running dependent out of the ready queue.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `initial_skips_summary_release_keeps_running_dependent_unready` passes 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `initial_skip` passes 8/8 with `timeout 120s`, `--jobs 1`, and `--trace-panic`; serial SA backend focused filter `initial_skip` passes 8/8 with `timeout 180s`, `--jobs 1`, and `--trace-panic` after waiting for another SA test process to finish. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor dependent-release running guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6819 tests-dir `@test` annotations | 7455 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 489 - `executor_multi_threaded_deep` mark-ready state guard fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_mark_ready` so running and skipped-pending systems cannot be marked ready.
- [x] Added `mt_deep_mark_ready_ignores_running_system` and `mt_deep_mark_ready_ignores_skipped_pending_system`, proving those inputs preserve running/skipped state without creating ready entries.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filter `mark_ready` passes 2/2 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `state` passes 12/12 with `timeout 120s`, `--jobs 1`, and `--trace-panic`; serial SA backend focused filter `mark_ready` passes 2/2 with `timeout 180s`, `--jobs 1`, and `--trace-panic` after waiting for other SA test processes to finish. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor mark-ready running/skipped guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6821 tests-dir `@test` annotations | 7457 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 490 - `executor_multi_threaded_deep` skip running guard fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_skip_system` so a running system cannot be marked skipped/completed while still running.
- [x] Fixed `ecs_executor_state_deep_mark_skipped_pending` so a running system cannot be marked skipped-pending.
- [x] Added `mt_deep_skip_system_ignores_running_system` and `mt_deep_mark_skipped_pending_ignores_running_system`, proving both helpers preserve running state without adding skipped/completed/ready state.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `skip_system_ignores_running_system` passes 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `mark_skipped_pending` passes 2/2 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; default backend focused filter `skip` passes 30/30 with `timeout 120s`, `--jobs 1`, and `--trace-panic`; serial SA backend focused filter `mark_skipped_pending` passes 2/2 and exact filter `skip_system_ignores_running_system` passes 1/1 with `timeout 180s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor skip running guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6823 tests-dir `@test` annotations | 7459 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 491 - `executor_multi_threaded_deep` complete running guard fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_complete_system` so a non-running system cannot be marked completed/unapplied.
- [x] Fixed `ecs_executor_state_deep_complete_system_with_dependents3` so an ignored non-running completion cannot release dependents.
- [x] Added `mt_deep_complete_system_ignores_not_running_system` and `mt_deep_complete_with_dependents_ignores_not_running_system`, proving both direct and dependent-release paths preserve state for invalid no-op completions.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filters `complete_system_ignores` and `complete_with_dependents_ignores` each pass 1/1 with `timeout 90s`, `--jobs 1`, and `--trace-panic`; serial SA backend exact filters `complete_system_ignores` and `complete_with_dependents_ignores` each pass 1/1 with `timeout 180s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor complete running guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6825 tests-dir `@test` annotations | 7461 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 492 - `executor_multi_threaded_deep` skip no-op release guard fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_skip_system` so completed and already skipped systems stay no-op inputs.
- [x] Fixed `ecs_executor_state_deep_skip_system_with_dependents3` so invalid no-op skip inputs, running systems, completed systems, and already skipped systems cannot release dependents.
- [x] Added `mt_deep_skip_system_ignores_completed_system`, `mt_deep_skip_with_dependents_ignores_running_system`, and `mt_deep_skip_with_dependents_ignores_completed_system`, proving direct and dependent-release paths preserve state for ignored skip inputs.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filters `skip_system_ignores` and `skip_with_dependents_ignores` each pass 2/2 with `timeout 100s`, `--jobs 1`, and `--trace-panic`; serial SA backend focused filters `skip_system_ignores` and `skip_with_dependents_ignores` each pass 2/2 with `timeout 180s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor skip no-op release guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6828 tests-dir `@test` annotations | 7464 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 493 - `executor_multi_threaded_deep` skipped spawn guard fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_mark_skipped_pending` so skipped-pending systems clear stale ready state.
- [x] Fixed `ecs_executor_state_deep_can_spawn_system` and `ecs_executor_state_deep_start_system` so skipped systems cannot be spawned, including direct start helper calls.
- [x] Added `mt_deep_mark_skipped_pending_clears_ready_and_blocks_spawn`, `mt_deep_failed_system_condition_clears_ready_and_blocks_spawn`, and `mt_deep_start_system_ignores_skipped_pending_system`, proving pending-skip and failed-condition paths cannot leave spawnable work behind.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filter `skipped_pending` passes 5/5, exact filter `failed_system_condition_clears` passes 1/1, and focused filter `state` passes 12/12 with `timeout`, `--jobs 1`, and `--trace-panic`; serial SA backend focused filter `skipped_pending` passes 5/5 and exact filter `failed_system_condition_clears` passes 1/1 with `timeout 180s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor skipped spawn guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6831 tests-dir `@test` annotations | 7467 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 494 - `executor_multi_threaded_deep` dependency spawn guard fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_set_dependencies` so positive dependency counts clear stale ready state.
- [x] Fixed `ecs_executor_state_deep_can_spawn_system` and `ecs_executor_state_deep_start_system` so unresolved dependencies block both scheduler and direct-start paths.
- [x] Added `mt_deep_set_dependencies_clears_stale_ready_and_blocks_spawn` and `mt_deep_start_system_ignores_dependency_blocked_system`, proving dependency updates cannot leave spawnable work behind.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filter `dependencies` passes 3/3, exact filter `dependency_blocked_system` passes 1/1, and focused filter `state` passes 12/12 with timeout-bounded `--jobs 1`; serial SA backend focused filter `dependencies` passes 3/3 and exact filter `dependency_blocked_system` passes 1/1 with `timeout 180s`, `--jobs 1`, and `--trace-panic`, after waiting for external SA tests to finish. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor dependency spawn guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6833 tests-dir `@test` annotations | 7469 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 495 - `executor_multi_threaded_deep` zero-dependency release guard fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_release_dependent` so only a positive dependency count transitioning to zero creates ready state.
- [x] Ensured already-zero dependent entries remain no-op inputs for both direct release and completion-with-dependents paths.
- [x] Added `mt_deep_release_dependent_ignores_zero_dependency_system` and `mt_deep_complete_with_dependents_ignores_zero_dependency_entry`, proving zero-count release inputs cannot create spurious ready work.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filter `release_dependent` passes 2/2, exact filter `ignores_zero_dependency_entry` passes 1/1, and focused filter `with_dependents` passes 6/6 with timeout-bounded `--jobs 1`; serial SA backend focused filter `release_dependent` passes 2/2 and exact filter `ignores_zero_dependency_entry` passes 1/1 with `timeout 180s`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor zero-dependency release guard 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6835 tests-dir `@test` annotations | 7471 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 496 - `executor_multi_threaded_deep` complete-ready no-op summary fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_complete_ready_batch_summary_deep3` so start slots are recorded only when `start_system` actually transitions the selected system to running.
- [x] Fixed completion slots so dependency-blocked, skipped, or otherwise non-running selected entries are not reported as completed.
- [x] Added `mt_deep_complete_ready_batch_summary_ignores_dependency_blocked_selected` and `mt_deep_complete_ready_batch_summary_ignores_skipped_selected`, proving invalid selected inputs remain no-op summary entries.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filter `complete_ready_batch_summary_ignores` passes 2/2 and focused filter `complete_ready_batch` passes 10/10 with timeout-bounded `--jobs 1` and a clean process exit; serial SA backend focused filter `complete_ready_batch_summary_ignores` passes 2/2 with `timeout 180s`, `--jobs 1`, and `--trace-panic` after waiting for external SA/SAB tests to finish. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor complete-ready no-op summary accounting 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6837 tests-dir `@test` annotations | 7473 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 497 - `executor_multi_threaded_deep` pending-skip finalization fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_skip_system` and `ecs_executor_state_deep_skip_system_with_dependents3` so pending skips (`skipped=true`, `completed=false`) can still be finalized and release dependents.
- [x] Fixed `ecs_executor_state_deep_drive_one_summary` so pending skips are handled before `can_spawn`, avoiding a false stalled result.
- [x] Added `mt_deep_skip_with_dependents_finalizes_pending_skip` and `mt_deep_drive_one_finalizes_pending_skip_and_releases`, proving pending skips become completed and release dependents through direct and drive-one paths.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filters `pending_skip`, `skip_with_dependents`, and `drive_one` pass 2/2, 4/4, and 4/4 respectively with timeout-bounded `--jobs 1` and clean process exits; serial SA backend focused filter `pending_skip` passes 2/2 with `timeout 180s`, `--jobs 1`, and `--trace-panic` after waiting for external SAB tests to finish. Whole-file executor-deep runs remain intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6839 tests-dir `@test` annotations | 7475 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 498 - `executor_multi_threaded_deep` integration pending-skip finalization fix (DONE 2026-07-15)
- [x] Fixed integration ready-batch selection so skipped-pending systems remain unspawnable and dependency-blocked systems are rejected by the scan guard.
- [x] Fixed `ecs_executor_drive_ready_batch_integration_summary_deep3` and `ecs_executor_drive_all_batched_integration_summary_deep3` so pending skips are finalized before normal selection, counted as skipped, completed, and used to release dependents in the same scan/wave.
- [x] Added `mt_deep_drive_ready_batch_integration_finalizes_pending_skip` and `mt_deep_drive_all_batched_integration_finalizes_pending_skip`, proving an integration pending skip releases a dependent system that then runs without false stall.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend focused filters `integration_finalizes_pending_skip`, `drive_ready_batch_integration`, and `drive_all_batched_integration` pass 2/2, 8/8, and 9/9 respectively with timeout-bounded `--jobs 1` and clean process exits; serial SA backend focused filter `integration_finalizes_pending_skip` passes 2/2 with `timeout 180s`, `--jobs 1`, and `--trace-panic` after checking for existing SA/SAB processes. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor integration pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6841 tests-dir `@test` annotations | 7477 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 499 - `executor_multi_threaded_deep` ready-batch rescan pending-skip finalization fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_ready_batch_rescan_summary_deep3` so skipped-pending systems are finalized before ordinary ready selection, without requiring stale ready state.
- [x] Preserved rescan semantics after finalization so released dependents can be selected in the same modeled ready-batch rescan.
- [x] Added `mt_deep_ready_batch_rescan_finalizes_pending_skip`, proving a pending skip releases its dependent and avoids a false stall in the rescan path.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `ready_batch_rescan_finalizes_pending_skip` passes 1/1 and focused filter `ready_batch_rescan` passes 8/8 with timeout-bounded `--jobs 1` and clean process exits; serial SA backend exact filter `ready_batch_rescan_finalizes_pending_skip` passes 1/1 with `timeout 180s`, `--jobs 1`, and `--trace-panic` after waiting for external SA tests. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch rescan pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6842 tests-dir `@test` annotations | 7478 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 500 - `executor_multi_threaded_deep` tick-with-completions pending-skip finalization fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_tick_with_completions_summary_deep3` so skipped-pending systems are finalized before ordinary ready selection in the post-drain rescan loop.
- [x] Preserved same-tick rescan semantics after finalization so released dependents can be selected after completion drain and pending-skip release.
- [x] Added `mt_deep_tick_with_completions_summary_finalizes_pending_skip`, proving a pending skip releases its dependent in the tick-with-completions path without false stall.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `tick_with_completions_summary_finalizes_pending_skip` passes 1/1 and focused filter `tick_with_completions_summary` passes 7/7 with timeout-bounded `--jobs 1` and clean process exits; serial SA backend exact filter `tick_with_completions_summary_finalizes_pending_skip` passes 1/1 with `timeout 180s`, `--jobs 1`, and `--trace-panic` after waiting for external SAB tests. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor tick-with-completions pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6843 tests-dir `@test` annotations | 7479 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 501 - `executor_multi_threaded_deep` run-history pending-skip classification fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_run_history_deep_drive_one` so skipped-pending systems are recorded as skipped before the `can_spawn` gate.
- [x] Preserved history-only semantics: this helper still does not mutate state or release dependents, but it no longer reports pending skips as stalled.
- [x] Added `mt_deep_run_history_drive_one_records_pending_skip`, proving pending skips are classified as skipped with no run/apply entries.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `run_history_drive_one_records_pending_skip` passes 1/1 and focused filter `run_history_drive` passes 3/3 with timeout-bounded `--jobs 1` and clean process exits; serial SA backend exact filter `run_history_drive_one_records_pending_skip` passes 1/1 with `timeout 180s`, `--jobs 1`, and `--trace-panic` after waiting for external SA tests. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor run-history pending-skip classification 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6844 tests-dir `@test` annotations | 7480 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 502 - `executor_multi_threaded_deep` no-drain tick pending-skip finalization fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_tick_with_completions_summary_deep3` so the `done_count == 0` path no longer bypasses pending-skip finalization when skipped-pending systems exist.
- [x] Preserved the existing fast no-drain ready-batch path for ordinary states with no pending skips, keeping the previous no-completion selection behavior intact.
- [x] Added `mt_deep_tick_with_completions_no_drain_finalizes_pending_skip`, proving a no-drain tick finalizes a pending skip, releases its dependent, and selects that dependent without false stall.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_tick_with_completions_no_drain_finalizes_pending_skip` passes 1/1 and focused filter `tick_with_completions_summary` passes 7/7 with timeout-bounded `--jobs 1` and clean process exits. SA backend exact filter was not started because another SA backend test process was already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor no-drain tick pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6845 tests-dir `@test` annotations | 7481 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 503 - `executor_multi_threaded_deep` drive-ready-batch pending-skip summary fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_drive_ready_batch_summary3` so skipped-pending systems are finalized before ordinary ready-batch selection.
- [x] Preserved this helper's existing summary-only scope: it counts and completes pending skips without attempting dependent release because the helper has no dependent list inputs.
- [x] Added `mt_deep_drive_ready_batch_summary_finalizes_pending_skip`, proving a pending skip is counted as skipped/completed and a separate ready system is still selected without false stall.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_ready_batch_summary_finalizes_pending_skip` passes 1/1 and focused filter `drive_ready_batch_summary` passes 2/2 with timeout-bounded `--jobs 1` and clean process exits. SA backend exact filter was not started because another SA backend test process was already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-ready-batch pending-skip summary finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6846 tests-dir `@test` annotations | 7482 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 504 - `executor_multi_threaded_deep` zero-width drive-ready-batch pending-skip summary fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_drive_ready_batch_summary3` so skipped-pending systems are finalized before the `max_width <= 0` early return.
- [x] Preserved zero-width semantics for ordinary ready work: no ready systems are selected when width is zero, but pending skip finalization can still be summarized because it does not consume batch width.
- [x] Added `mt_deep_drive_ready_batch_summary_zero_width_finalizes_pending_skip`, proving a zero-width summary finalizes pending skip without false stall and without selecting ready work.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_ready_batch_summary_zero_width_finalizes_pending_skip` passes 1/1 and focused filter `drive_ready_batch_summary` passes 3/3 with timeout-bounded `--jobs 1` and clean process exits. SA backend exact filter was not started because another SAB backend test process was already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor zero-width drive-ready-batch pending-skip summary finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 524 lib modules | 249 `*_deep.sla` modules | 426 test files | 249 `*_deep_isolated.sla` test files | 90 examples | 6847 tests-dir `@test` annotations | 7483 lib/tests/examples `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 505 - `executor_multi_threaded_deep` zero-width integration/rescan pending-skip fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_ready_batch_rescan_summary_deep3`, `ecs_executor_tick_with_completions_summary_deep3`, `ecs_executor_drive_ready_batch_integration_summary_deep3`, and `ecs_executor_drive_all_batched_integration_summary_deep3` so skipped-pending systems are finalized before their `max_width <= 0` early returns.
- [x] Preserved zero-width semantics for ordinary ready work: no ready systems are selected or run when width is zero, but pending skip finalization can complete skipped systems, release dependents, and update ready/dependency summary state because it does not consume batch width.
- [x] Added `mt_deep_ready_batch_rescan_zero_width_finalizes_pending_skip`, `mt_deep_tick_with_completions_zero_width_finalizes_pending_skip`, `mt_deep_drive_ready_batch_integration_zero_width_finalizes_pending_skip`, and `mt_deep_drive_all_batched_integration_zero_width_finalizes_pending_skip`.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filters for the four new zero-width tests pass 1/1 each with timeout-bounded `--jobs 1` and clean process exits. Broader default filter `zero_width_finalizes_pending_skip` timed out at 90s under concurrent external SA/SAB test load and was not counted; SA backend filters were not started because external SA/SAB backend tests were already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor zero-width integration/rescan pending-skip finalization 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6851 tests-dir `@test` annotations | 7451 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 506 - `executor_multi_threaded_deep` no-drain tick gate summary fix (DONE 2026-07-15)
- [x] Fixed `_mt_tick_with_completions_no_drain_fast` so no-completion tick summaries preserve existing `local_thread_running` and `exclusive_running` gate state before overlaying newly selected systems.
- [x] Added `mt_deep_tick_with_completions_no_drain_preserves_existing_local_gate`, proving an already-running local system remains reflected in summary gate accessors when the no-drain fast path selects an additional ordinary ready system.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_tick_with_completions_no_drain_preserves_existing_local_gate` passes 1/1 and focused filter `no_drain` passes 2/2 with timeout-bounded `--jobs 1` and clean process exits. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor no-drain tick gate-state summary preservation 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6852 tests-dir `@test` annotations | 7452 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 507 - `executor_multi_threaded_deep` no-drain exclusive gate coverage (DONE 2026-07-15)
- [x] Added `mt_deep_tick_with_completions_no_drain_preserves_existing_exclusive_gate`, proving the no-drain fast path reports an already-running exclusive system as both exclusive-running and local-running, selects no additional ready work while the exclusive gate is occupied, and leaves ordinary ready work visible in the summary.
- [x] Validated the Batch 506 gate-state preservation fix for the exclusive branch; no executor implementation, API surface, or SLA compiler behavior changed.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_tick_with_completions_no_drain_preserves_existing_exclusive_gate` passes 1/1 and focused filter `no_drain` passes 3/3 with timeout-bounded `--jobs 1` and clean process exits. SA backend filters were not started because an external SA backend test process was already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor no-drain exclusive gate summary coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6853 tests-dir `@test` annotations | 7453 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 508 - `executor_multi_threaded_deep` no-drain local gate scan coverage (DONE 2026-07-15)
- [x] Added `mt_deep_tick_with_completions_no_drain_existing_local_blocks_second_local`, proving the no-drain fast path skips a second ready local system while an existing local system is running, but keeps scanning and selects a later ordinary ready system.
- [x] Validated the Batch 506 gate-state preservation and ready-scan behavior for occupied local gates; no executor implementation, API surface, or SLA compiler behavior changed.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_tick_with_completions_no_drain_existing_local_blocks_second_local` passes 1/1 and focused filter `no_drain` passes 4/4 with timeout-bounded `--jobs 1` and clean process exits. SA backend filters were not started because an external SA backend test process was already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor no-drain local gate scan coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6854 tests-dir `@test` annotations | 7454 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 509 - `executor_multi_threaded_deep` no-drain width-limit ready coverage (DONE 2026-07-15)
- [x] Added `mt_deep_tick_with_completions_no_drain_width_limit_leaves_remaining_ready`, proving the no-drain fast path selects only the first ready system when `max_width=1` and keeps later ready systems visible in the summary.
- [x] Validated that width truncation does not let unselected systems affect local/exclusive gate summary fields; no executor implementation, API surface, or SLA compiler behavior changed.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_tick_with_completions_no_drain_width_limit_leaves_remaining_ready` passes 1/1 and focused filter `no_drain` passes 5/5 with timeout-bounded `--jobs 1` and clean process exits. SA backend filters were not started because external SA/SAB backend tests were already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor no-drain width-limit ready coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6855 tests-dir `@test` annotations | 7455 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 510 - `executor_multi_threaded_deep` ready-batch exclusive flag fix (DONE 2026-07-15)
- [x] Fixed `ecs_executor_state_deep_take_ready_batch3` so an exclusive system selected from the second or third candidate slot after earlier unready candidates marks the returned ready batch as exclusive and local.
- [x] Added `mt_deep_ready_batch_exclusive_after_unready_candidate_sets_flags`, proving the exclusive selected system stands alone and reports the correct batch flags.
- [x] Kept API surface and SLA compiler unchanged; this was an executor deep behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_ready_batch_exclusive_after_unready_candidate_sets_flags` passes 1/1 and focused filter `mt_deep_ready_batch` passes 14/14 with timeout-bounded `--jobs 1` and clean process exits. SA backend filters were not started because external SA/SAB backend tests were already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch exclusive flag parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6856 tests-dir `@test` annotations | 7456 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 511 - `executor_multi_threaded_deep` ready-batch third exclusive coverage (DONE 2026-07-15)
- [x] Added `mt_deep_ready_batch_third_exclusive_after_unready_candidates_sets_flags`, proving the Batch 510 exclusive/local batch flag propagation also covers an exclusive third candidate after two unready candidates.
- [x] Validated the third-candidate variant without changing executor implementation, API surface, or SLA compiler behavior in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_ready_batch_third_exclusive_after_unready_candidates_sets_flags` passes 1/1 and focused filter `mt_deep_ready_batch` passes 15/15 with timeout-bounded `--jobs 1` and clean process exits. SA backend filters were not started because an external SA backend test process was already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch third-candidate exclusive coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6857 tests-dir `@test` annotations | 7457 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 512 - `executor_multi_threaded_deep` drive-ready-batch second exclusive coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_ready_batch_integration_second_exclusive_stands_alone_after_unready`, proving drive-ready-batch integration keeps a later ordinary ready system out of the same batch when an exclusive second candidate is the first actual selected system.
- [x] Validated the integration-layer exclusive gate path without changing executor implementation, API surface, or SLA compiler behavior in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_ready_batch_integration_second_exclusive_stands_alone_after_unready` passes 1/1 and focused filter `drive_ready_batch_integration` passes 10/10 with timeout-bounded `--jobs 1` and clean process exits. SA backend filters were not started per memory/OOM guidance; whole-file executor-deep runs intentionally avoided.
- [x] Feature progress: multi-threaded executor drive-ready-batch second-candidate exclusive integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6858 tests-dir `@test` annotations | 7458 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 513 - `executor_multi_threaded_deep` drive-ready-batch third exclusive coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_ready_batch_integration_third_exclusive_stands_alone_after_unready`, proving drive-ready-batch integration runs an exclusive third candidate alone when earlier candidates are unready.
- [x] Validated the third-candidate integration exclusive path without changing executor implementation, API surface, or SLA compiler behavior in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_ready_batch_integration_third_exclusive_stands_alone_after_unready` passes 1/1 and focused filter `drive_ready_batch_integration` passes 11/11 with timeout-bounded `--jobs 1` and clean process exits. SA backend filters were not started per memory/OOM guidance; whole-file executor-deep runs intentionally avoided.
- [x] Feature progress: multi-threaded executor drive-ready-batch third-candidate exclusive integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6859 tests-dir `@test` annotations | 7459 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 514 - `executor_multi_threaded_deep` drive-all second exclusive coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_all_batched_integration_second_exclusive_after_unready_splits_waves`, proving drive-all batched integration runs an exclusive second candidate alone when candidate 0 is initially dependency-blocked, then releases candidate 0 so it can complete with candidate 2 in the next wave.
- [x] Validated the drive-all exclusive gate path without changing executor implementation, API surface, or SLA compiler behavior in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_all_batched_integration_second_exclusive_after_unready_splits_waves` passes 1/1 and focused filter `drive_all_batched_integration` passes 11/11 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits. SA backend exact filter was not started because an external SA backend process was already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-all second-candidate exclusive integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6860 tests-dir `@test` annotations | 7460 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 515 - `executor_multi_threaded_deep` drive-all third exclusive coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_all_batched_integration_third_exclusive_after_unready_splits_waves`, proving drive-all batched integration runs an exclusive third candidate alone when candidates 0 and 1 are initially dependency-blocked, then releases both so they complete together in the next wave.
- [x] Validated the third-candidate drive-all exclusive gate path without changing executor implementation, API surface, or SLA compiler behavior in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_all_batched_integration_third_exclusive_after_unready_splits_waves` passes 1/1 and focused filter `drive_all_batched_integration` passes 12/12 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits. SA/SAB backend exact filter was not started because external SAB backend processes were already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-all third-candidate exclusive integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6861 tests-dir `@test` annotations | 7461 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 516 - `executor_multi_threaded_deep` drive-all second local coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_all_batched_integration_second_local_after_unready_keeps_ordinary_same_wave`, proving drive-all batched integration can select a second-slot local system after an initially dependency-blocked candidate while still keeping ordinary ready work in the same wave.
- [x] Validated that the local-thread gate blocks only conflicting local work, not ordinary work, and that the local system can release the blocked earlier candidate for the next wave. No executor implementation, API surface, or SLA compiler behavior changed in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_all_batched_integration_second_local_after_unready_keeps_ordinary_same_wave` passes 1/1 and focused filter `drive_all_batched_integration` passes 13/13 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits; serial SA backend exact filter passes 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-all second-candidate local gate integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6862 tests-dir `@test` annotations | 7462 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 517 - `executor_multi_threaded_deep` drive-all third local coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_all_batched_integration_third_local_after_unready_splits_waves`, proving drive-all batched integration can select a third-slot local system after two initially dependency-blocked candidates, then release both for a second wave.
- [x] Validated the third-candidate local-thread gate path without changing executor implementation, API surface, or SLA compiler behavior in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_all_batched_integration_third_local_after_unready_splits_waves` passes 1/1 and focused filter `drive_all_batched_integration` passes 14/14 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits; serial SA backend exact filter passes 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-all third-candidate local gate integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6863 tests-dir `@test` annotations | 7463 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 518 - `executor_multi_threaded_deep` ready-batch second local coverage (DONE 2026-07-15)
- [x] Added `mt_deep_ready_batch_second_local_after_unready_keeps_ordinary`, proving base ready-batch selection can select a second-slot local system after an unready first candidate while still including an ordinary ready candidate in the same batch.
- [x] Validated that the returned batch reports `is_local` without incorrectly reporting `is_exclusive`; no executor implementation, API surface, or SLA compiler behavior changed in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_ready_batch_second_local_after_unready_keeps_ordinary` passes 1/1 and focused filter `mt_deep_ready_batch` passes 16/16 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits. SA backend exact filter was not started because an external SA backend process was already running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch second-candidate local gate coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6864 tests-dir `@test` annotations | 7464 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 519 - `executor_multi_threaded_deep` ready-batch third local coverage (DONE 2026-07-15)
- [x] Added `mt_deep_ready_batch_third_local_after_unready_candidates_sets_flags`, proving base ready-batch selection reports local-thread ownership when a third-slot local system is selected after two unready candidates.
- [x] Validated that the returned batch remains non-exclusive; no executor implementation, API surface, or SLA compiler behavior changed in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_ready_batch_third_local_after_unready_candidates_sets_flags` passes 1/1 and focused filter `mt_deep_ready_batch` passes 17/17 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits; serial SA backend exact filter passes 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch third-candidate local gate coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6865 tests-dir `@test` annotations | 7465 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 520 - `executor_multi_threaded_deep` drive-ready-batch second local coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_ready_batch_integration_second_local_after_unready_keeps_ordinary`, proving drive-ready-batch integration runs a second-slot local system and a later ordinary ready system in the same batch when the first candidate is unready.
- [x] Validated that the integration path clears both selected ready flags, records both completions, and does not falsely stall; no executor implementation, API surface, or SLA compiler behavior changed in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_ready_batch_integration_second_local_after_unready_keeps_ordinary` passes 1/1 and focused filter `drive_ready_batch_integration` passes 12/12 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits; serial SA backend exact filter passes 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-ready-batch second-candidate local gate integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6866 tests-dir `@test` annotations | 7466 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 521 - `executor_multi_threaded_deep` drive-ready-batch third local coverage (DONE 2026-07-15)
- [x] Added `mt_deep_drive_ready_batch_integration_third_local_after_unready_runs_local`, proving drive-ready-batch integration runs and completes a third-slot local system when the earlier candidates are unready.
- [x] Validated that the integration path clears the selected ready flag and does not falsely stall; no executor implementation, API surface, or SLA compiler behavior changed in this batch.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_drive_ready_batch_integration_third_local_after_unready_runs_local` passes 1/1 and focused filter `drive_ready_batch_integration` passes 13/13 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits; serial SA backend exact filter passes 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor drive-ready-batch third-candidate local gate integration coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6867 tests-dir `@test` annotations | 7467 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 522 - `executor_multi_threaded_deep` ready-batch rescan selected-count fix (DONE 2026-07-15)
- [x] Fixed `_mt_ready_batch_rescan_push_selected` so the second and third selected systems are recorded with a stable slot position and `selected_count` is incremented after slot assignment.
- [x] Added `mt_deep_ready_batch_rescan_local_after_skip_keeps_ordinary_same_batch`, proving rescan summary accounting matches state mutation when a skipped system releases local work and later ordinary ready work starts in the same batch.
- [x] Kept SLA compiler behavior and public API surface unchanged; this was an executor deep summary behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_ready_batch_rescan_local_after_skip_keeps_ordinary_same_batch` passes 1/1 and focused filter `ready_batch_rescan` passes 10/10 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits; serial SA backend exact filter passes 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch rescan summary selected-count parity for local-plus-ordinary post-skip batches 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6868 tests-dir `@test` annotations | 7468 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 523 - `executor_multi_threaded_deep` ready-batch rescan third-slot coverage (DONE 2026-07-15)
- [x] Added `mt_deep_ready_batch_rescan_records_three_selected_slots`, proving ready-batch rescan records all three selected slots when three ordinary systems are ready in the same pass.
- [x] Validated `selected_count=3`, stable 0/1/2 slot order, zero ready systems after selection, three running systems, and no false stall.
- [x] Kept executor implementation, public API surface, and SLA compiler behavior unchanged; this batch completes coverage for the third slot of the Batch 522 fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_ready_batch_rescan_records_three_selected_slots` passes 1/1 and focused filter `ready_batch_rescan` passes 11/11 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits; serial SA backend exact filter passes 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor ready-batch rescan third selected-slot coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6869 tests-dir `@test` annotations | 7469 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 524 - `executor_multi_threaded_deep` tick no-drain third-slot coverage (DONE 2026-07-15)
- [x] Added `mt_deep_tick_with_completions_no_drain_records_three_selected_slots`, proving the no-completion fast path records all three ordinary ready systems when `max_width=3`.
- [x] Validated selected slot order, out-of-bounds accessor behavior, ready/running counts, cleared ready flags, and unchanged local/exclusive gate state.
- [x] Kept executor implementation, public API surface, and SLA compiler behavior unchanged.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_tick_with_completions_no_drain_records_three_selected_slots` passes 1/1 and focused filter `no_drain` passes 6/6 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits. SA backend exact filter was not started because external SAB backend tests were running; whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor tick-with-completions no-drain third selected-slot coverage 0% -> 100% for this focused scenario; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6870 tests-dir `@test` annotations | 7470 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 525 - `executor_multi_threaded_deep` completion-drain multi-select fix (DONE 2026-07-15)
- [x] Fixed `_mt_tick_with_completions_push_selected` so completion-drain ticks reliably record second and third selected slots.
- [x] Added `mt_deep_tick_with_completions_releases_and_keeps_ordinary_same_batch`, proving completing system 0 can release system 1 and select it together with already-ready system 2 in the same tick.
- [x] Validated completion history, selected slot order, dependency release, ready/running/completed state, and no false stall.
- [x] Kept public API surface and SLA compiler behavior unchanged; this was an executor deep summary behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_tick_with_completions_releases_and_keeps_ordinary_same_batch` passes 1/1 and focused filter `mt_deep_tick_with_completions` passes 15/15 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits; serial SA backend exact filter passes 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor tick-with-completions completion-drain multi-select summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6871 tests-dir `@test` annotations | 7471 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.


# Batch 526 - `executor_multi_threaded_deep` completion-drain completed-count fix (DONE 2026-07-15)
- [x] Fixed `_mt_tick_with_completions_push_completed` so second and third completed systems are recorded with stable slot positions.
- [x] Added `mt_deep_tick_with_completions_records_two_completed_slots`, proving one tick can drain two completed systems, release a two-dependency join, and select the released dependent while reporting both completed slots.
- [x] Validated completed slot order, out-of-bounds completed accessor behavior, dependency release, selected dependent, ready/running/completed state, and no false stall.
- [x] Kept public API surface and SLA compiler behavior unchanged; this was an executor deep summary behavior fix.
- [x] Verification: `timeout 45s env SA_PLUGIN_DEV=1 sa sla check lib/executor_multi_threaded_deep.sla`; `timeout 45s env SA_PLUGIN_DEV=1 sa sla check tests/test_ecs_lib_executor_multi_threaded_deep_isolated.sla`; default backend exact filter `mt_deep_tick_with_completions_records_two_completed_slots` passes 1/1 and focused filter `mt_deep_tick_with_completions` passes 16/16 with timeout-bounded `--jobs 1`, `--trace-panic`, and clean process exits; serial SA backend exact filter passes 1/1 with `timeout 180s`, `--test-backend sa`, `--jobs 1`, and `--trace-panic`. Whole-file executor-deep runs intentionally avoided per memory/OOM guidance.
- [x] Feature progress: multi-threaded executor tick-with-completions completion-drain completed-slot summary parity 0% -> 100% for this focused behavior fix; overall API parity remains ~94–96%, behavioral parity remains ~86–91%.
### Current measured counts: 521 lib `.sla` modules | 249 `*_deep.sla` modules | 425 test `.sla` files | 249 `*_deep_isolated.sla` test files | 90 examples | 6872 tests-dir `@test` annotations | 7472 lib/tests/examples `.sla` `@test` annotations. Remaining optional depth: broader executor integration scenarios if new Bevy parity gaps are found.
