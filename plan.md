...
- The next runtime step is integrating archetype locations with table-row component storage and broader system params over the registry-owned world, then parallel scheduling.
