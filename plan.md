...
- Integrate generic relationships with table-erased component storage in `sla_ecs`: synchronized entity allocation/free-list ordering, relationship-aware linked despawn cleanup, and ordered commands that mix component inserts, indexed relationship mutations, and despawn.
