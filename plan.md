...
- The next runtime step is adding system-param adapters over heterogeneous table-row storage, then automatic component metadata and parallel scheduling.
