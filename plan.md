...
- The next runtime step is expanding system params toward typed command/resource/message reader shapes and tightening toward full Bevy table-row layout and parallel scheduling.
