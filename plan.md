...
- `lib/world_dynamic.sla` and `lib/world_archetype_value.sla` track resource added/changed ticks and expose `Res<T>` / `ResMut<T>` wrappers for Bevy-style resource systems.
