...
- Implement Entity-keyed collection helpers with correct value-key semantics, including ordered unique vectors for relationship/query helper paths, before relying on std hash containers for `Entity` keys.
