...
- The next runtime step is moving Commands/Schedule and broader system params onto the archetype-backed value world, then tightening toward full Bevy table-row layout and parallel scheduling.
