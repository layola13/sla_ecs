...
- The next runtime step is broader system params over the archetype-backed value world, then tightening toward full Bevy table-row layout and parallel scheduling.
