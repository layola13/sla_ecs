...
- The next runtime step is moving Commands/Schedule and broader system params onto the type-erased registry world, then adding archetype grouping and parallel scheduling.
