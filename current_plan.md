...
- Counts (measured 2026-07-03): 230 lib `.sla` modules; 155 `tests/*.sla` files; 90 `examples/*.sla`; 7,011 `@test` annotations total across lib/tests/examples. (Earlier statements of "1795/92/170" and "1415/76" were stale and understated.)
